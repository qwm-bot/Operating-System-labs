...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	5e3030ef          	jal	ra,ffffffffc0203e44 <memset>
    dtb_init();
...
ffffffffc0200072:	e2a58593          	addi	a1,a1,-470 # ffffffffc0203e98 <etext+0x6>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	e4250513          	addi	a0,a0,-446 # ffffffffc0203eb8 <etext+0x26>
...
ffffffffc0200096:	56e030ef          	jal	ra,ffffffffc0203604 <proc_init>
...
ffffffffc02000a2:	7b0030ef          	jal	ra,ffffffffc0203852 <cpu_idle>
...
ffffffffc02000c0:	e0450513          	addi	a0,a0,-508 # ffffffffc0203ec0 <etext+0x2e>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	099030ef          	jal	ra,ffffffffc0203a20 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	063030ef          	jal	ra,ffffffffc0203a20 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	cea50513          	addi	a0,a0,-790 # ffffffffc0203ec8 <etext+0x36>
{
...
ffffffffc02001f8:	cf450513          	addi	a0,a0,-780 # ffffffffc0203ee8 <etext+0x56>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	c9258593          	addi	a1,a1,-878 # ffffffffc0203e92 <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	d0050513          	addi	a0,a0,-768 # ffffffffc0203f08 <etext+0x76>
...
ffffffffc0200220:	d0c50513          	addi	a0,a0,-756 # ffffffffc0203f28 <etext+0x96>
...
ffffffffc0200234:	d1850513          	addi	a0,a0,-744 # ffffffffc0203f48 <etext+0xb6>
...
ffffffffc0200262:	d0a50513          	addi	a0,a0,-758 # ffffffffc0203f68 <etext+0xd6>
}
...
ffffffffc0200270:	d2c60613          	addi	a2,a2,-724 # ffffffffc0203f98 <etext+0x106>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	d3850513          	addi	a0,a0,-712 # ffffffffc0203fb0 <etext+0x11e>
{
...
ffffffffc020028c:	d4060613          	addi	a2,a2,-704 # ffffffffc0203fc8 <etext+0x136>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	d5858593          	addi	a1,a1,-680 # ffffffffc0203fe8 <etext+0x156>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	d5850513          	addi	a0,a0,-680 # ffffffffc0203ff0 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	d5a60613          	addi	a2,a2,-678 # ffffffffc0204000 <etext+0x16e>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	d7a58593          	addi	a1,a1,-646 # ffffffffc0204028 <etext+0x196>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	d3a50513          	addi	a0,a0,-710 # ffffffffc0203ff0 <etext+0x15e>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	d7660613          	addi	a2,a2,-650 # ffffffffc0204038 <etext+0x1a6>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	d8e58593          	addi	a1,a1,-626 # ffffffffc0204058 <etext+0x1c6>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	d1e50513          	addi	a0,a0,-738 # ffffffffc0203ff0 <etext+0x15e>
...
ffffffffc0200310:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204068 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	d6250513          	addi	a0,a0,-670 # ffffffffc0204090 <etext+0x1fe>
...
ffffffffc020035c:	d6090913          	addi	s2,s2,-672 # ffffffffc02040b8 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	d6048493          	addi	s1,s1,-672 # ffffffffc02040c0 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	d5eb0b13          	addi	s6,s6,-674 # ffffffffc02040c8 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	c76a0a13          	addi	s4,s4,-906 # ffffffffc0203fe8 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	249030ef          	jal	ra,ffffffffc0203dea <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	235030ef          	jal	ra,ffffffffc0203dea <strcmp>
...
ffffffffc02003f4:	23b030ef          	jal	ra,ffffffffc0203e2e <strchr>
...
ffffffffc0200432:	1fd030ef          	jal	ra,ffffffffc0203e2e <strchr>
...
ffffffffc0200450:	c9c50513          	addi	a0,a0,-868 # ffffffffc02040e8 <etext+0x256>
...
ffffffffc0200746:	65c030ef          	jal	ra,ffffffffc0203da2 <strlen>
...
ffffffffc0200752:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc0200754:	6b4030ef          	jal	ra,ffffffffc0203e08 <strncmp>
...
ffffffffc02007ea:	600030ef          	jal	ra,ffffffffc0203dea <strcmp>
...
ffffffffc0200b94:	b9870713          	addi	a4,a4,-1128 # ffffffffc0204728 <commands+0x628>
...
ffffffffc0200bfe:	b0e50513          	addi	a0,a0,-1266 # ffffffffc0204708 <commands+0x608>
...
ffffffffc0200c32:	ab250513          	addi	a0,a0,-1358 # ffffffffc02046e0 <commands+0x5e0>
...
ffffffffc0200c56:	c9e70713          	addi	a4,a4,-866 # ffffffffc02048f0 <commands+0x7f0>
...
ffffffffc0200e9e:	b6e63603          	ld	a2,-1170(a2) # ffffffffc0205a08 <nbase>
...
ffffffffc02010e4:	85068693          	addi	a3,a3,-1968 # ffffffffc0204930 <commands+0x830>
ffffffffc02010e8:	00004617          	auipc	a2,0x4
ffffffffc02010ec:	85860613          	addi	a2,a2,-1960 # ffffffffc0204940 <commands+0x840>
ffffffffc02010f0:	0f000593          	li	a1,240
ffffffffc02010f4:	00004517          	auipc	a0,0x4
ffffffffc02010f8:	86450513          	addi	a0,a0,-1948 # ffffffffc0204958 <commands+0x858>
ffffffffc02010fc:	b5eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201100:	00004697          	auipc	a3,0x4
ffffffffc0201104:	8f068693          	addi	a3,a3,-1808 # ffffffffc02049f0 <commands+0x8f0>
ffffffffc0201108:	00004617          	auipc	a2,0x4
ffffffffc020110c:	83860613          	addi	a2,a2,-1992 # ffffffffc0204940 <commands+0x840>
ffffffffc0201110:	0bd00593          	li	a1,189
ffffffffc0201114:	00004517          	auipc	a0,0x4
ffffffffc0201118:	84450513          	addi	a0,a0,-1980 # ffffffffc0204958 <commands+0x858>
ffffffffc020111c:	b3eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201120:	00004697          	auipc	a3,0x4
ffffffffc0201124:	8f868693          	addi	a3,a3,-1800 # ffffffffc0204a18 <commands+0x918>
ffffffffc0201128:	00004617          	auipc	a2,0x4
ffffffffc020112c:	81860613          	addi	a2,a2,-2024 # ffffffffc0204940 <commands+0x840>
ffffffffc0201130:	0be00593          	li	a1,190
ffffffffc0201134:	00004517          	auipc	a0,0x4
ffffffffc0201138:	82450513          	addi	a0,a0,-2012 # ffffffffc0204958 <commands+0x858>
ffffffffc020113c:	b1eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201140:	00004697          	auipc	a3,0x4
ffffffffc0201144:	91868693          	addi	a3,a3,-1768 # ffffffffc0204a58 <commands+0x958>
ffffffffc0201148:	00003617          	auipc	a2,0x3
ffffffffc020114c:	7f860613          	addi	a2,a2,2040 # ffffffffc0204940 <commands+0x840>
ffffffffc0201150:	0c000593          	li	a1,192
ffffffffc0201154:	00004517          	auipc	a0,0x4
ffffffffc0201158:	80450513          	addi	a0,a0,-2044 # ffffffffc0204958 <commands+0x858>
ffffffffc020115c:	afeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201160:	00004697          	auipc	a3,0x4
ffffffffc0201164:	98068693          	addi	a3,a3,-1664 # ffffffffc0204ae0 <commands+0x9e0>
ffffffffc0201168:	00003617          	auipc	a2,0x3
ffffffffc020116c:	7d860613          	addi	a2,a2,2008 # ffffffffc0204940 <commands+0x840>
ffffffffc0201170:	0d900593          	li	a1,217
ffffffffc0201174:	00003517          	auipc	a0,0x3
ffffffffc0201178:	7e450513          	addi	a0,a0,2020 # ffffffffc0204958 <commands+0x858>
ffffffffc020117c:	adeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201180:	00004697          	auipc	a3,0x4
ffffffffc0201184:	81068693          	addi	a3,a3,-2032 # ffffffffc0204990 <commands+0x890>
ffffffffc0201188:	00003617          	auipc	a2,0x3
ffffffffc020118c:	7b860613          	addi	a2,a2,1976 # ffffffffc0204940 <commands+0x840>
ffffffffc0201190:	0d200593          	li	a1,210
ffffffffc0201194:	00003517          	auipc	a0,0x3
ffffffffc0201198:	7c450513          	addi	a0,a0,1988 # ffffffffc0204958 <commands+0x858>
ffffffffc020119c:	abeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 3);
ffffffffc02011a0:	00004697          	auipc	a3,0x4
ffffffffc02011a4:	93068693          	addi	a3,a3,-1744 # ffffffffc0204ad0 <commands+0x9d0>
ffffffffc02011a8:	00003617          	auipc	a2,0x3
ffffffffc02011ac:	79860613          	addi	a2,a2,1944 # ffffffffc0204940 <commands+0x840>
ffffffffc02011b0:	0d000593          	li	a1,208
ffffffffc02011b4:	00003517          	auipc	a0,0x3
ffffffffc02011b8:	7a450513          	addi	a0,a0,1956 # ffffffffc0204958 <commands+0x858>
ffffffffc02011bc:	a9eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011c0:	00004697          	auipc	a3,0x4
ffffffffc02011c4:	8f868693          	addi	a3,a3,-1800 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc02011c8:	00003617          	auipc	a2,0x3
ffffffffc02011cc:	77860613          	addi	a2,a2,1912 # ffffffffc0204940 <commands+0x840>
ffffffffc02011d0:	0cb00593          	li	a1,203
ffffffffc02011d4:	00003517          	auipc	a0,0x3
ffffffffc02011d8:	78450513          	addi	a0,a0,1924 # ffffffffc0204958 <commands+0x858>
ffffffffc02011dc:	a7eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02011e0:	00004697          	auipc	a3,0x4
ffffffffc02011e4:	8b868693          	addi	a3,a3,-1864 # ffffffffc0204a98 <commands+0x998>
ffffffffc02011e8:	00003617          	auipc	a2,0x3
ffffffffc02011ec:	75860613          	addi	a2,a2,1880 # ffffffffc0204940 <commands+0x840>
ffffffffc02011f0:	0c200593          	li	a1,194
ffffffffc02011f4:	00003517          	auipc	a0,0x3
ffffffffc02011f8:	76450513          	addi	a0,a0,1892 # ffffffffc0204958 <commands+0x858>
ffffffffc02011fc:	a5eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != NULL);
ffffffffc0201200:	00004697          	auipc	a3,0x4
ffffffffc0201204:	92868693          	addi	a3,a3,-1752 # ffffffffc0204b28 <commands+0xa28>
ffffffffc0201208:	00003617          	auipc	a2,0x3
ffffffffc020120c:	73860613          	addi	a2,a2,1848 # ffffffffc0204940 <commands+0x840>
ffffffffc0201210:	0f800593          	li	a1,248
ffffffffc0201214:	00003517          	auipc	a0,0x3
ffffffffc0201218:	74450513          	addi	a0,a0,1860 # ffffffffc0204958 <commands+0x858>
ffffffffc020121c:	a3eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc0201220:	00004697          	auipc	a3,0x4
ffffffffc0201224:	8f868693          	addi	a3,a3,-1800 # ffffffffc0204b18 <commands+0xa18>
ffffffffc0201228:	00003617          	auipc	a2,0x3
ffffffffc020122c:	71860613          	addi	a2,a2,1816 # ffffffffc0204940 <commands+0x840>
ffffffffc0201230:	0df00593          	li	a1,223
ffffffffc0201234:	00003517          	auipc	a0,0x3
ffffffffc0201238:	72450513          	addi	a0,a0,1828 # ffffffffc0204958 <commands+0x858>
ffffffffc020123c:	a1eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201240:	00004697          	auipc	a3,0x4
ffffffffc0201244:	87868693          	addi	a3,a3,-1928 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc0201248:	00003617          	auipc	a2,0x3
ffffffffc020124c:	6f860613          	addi	a2,a2,1784 # ffffffffc0204940 <commands+0x840>
ffffffffc0201250:	0dd00593          	li	a1,221
ffffffffc0201254:	00003517          	auipc	a0,0x3
ffffffffc0201258:	70450513          	addi	a0,a0,1796 # ffffffffc0204958 <commands+0x858>
ffffffffc020125c:	9feff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201260:	00004697          	auipc	a3,0x4
ffffffffc0201264:	89868693          	addi	a3,a3,-1896 # ffffffffc0204af8 <commands+0x9f8>
ffffffffc0201268:	00003617          	auipc	a2,0x3
ffffffffc020126c:	6d860613          	addi	a2,a2,1752 # ffffffffc0204940 <commands+0x840>
ffffffffc0201270:	0dc00593          	li	a1,220
ffffffffc0201274:	00003517          	auipc	a0,0x3
ffffffffc0201278:	6e450513          	addi	a0,a0,1764 # ffffffffc0204958 <commands+0x858>
ffffffffc020127c:	9deff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201280:	00003697          	auipc	a3,0x3
ffffffffc0201284:	71068693          	addi	a3,a3,1808 # ffffffffc0204990 <commands+0x890>
ffffffffc0201288:	00003617          	auipc	a2,0x3
ffffffffc020128c:	6b860613          	addi	a2,a2,1720 # ffffffffc0204940 <commands+0x840>
ffffffffc0201290:	0b900593          	li	a1,185
ffffffffc0201294:	00003517          	auipc	a0,0x3
ffffffffc0201298:	6c450513          	addi	a0,a0,1732 # ffffffffc0204958 <commands+0x858>
ffffffffc020129c:	9beff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012a0:	00004697          	auipc	a3,0x4
ffffffffc02012a4:	81868693          	addi	a3,a3,-2024 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc02012a8:	00003617          	auipc	a2,0x3
ffffffffc02012ac:	69860613          	addi	a2,a2,1688 # ffffffffc0204940 <commands+0x840>
ffffffffc02012b0:	0d600593          	li	a1,214
ffffffffc02012b4:	00003517          	auipc	a0,0x3
ffffffffc02012b8:	6a450513          	addi	a0,a0,1700 # ffffffffc0204958 <commands+0x858>
ffffffffc02012bc:	99eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012c0:	00003697          	auipc	a3,0x3
ffffffffc02012c4:	71068693          	addi	a3,a3,1808 # ffffffffc02049d0 <commands+0x8d0>
ffffffffc02012c8:	00003617          	auipc	a2,0x3
ffffffffc02012cc:	67860613          	addi	a2,a2,1656 # ffffffffc0204940 <commands+0x840>
ffffffffc02012d0:	0d400593          	li	a1,212
ffffffffc02012d4:	00003517          	auipc	a0,0x3
ffffffffc02012d8:	68450513          	addi	a0,a0,1668 # ffffffffc0204958 <commands+0x858>
ffffffffc02012dc:	97eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012e0:	00003697          	auipc	a3,0x3
ffffffffc02012e4:	6d068693          	addi	a3,a3,1744 # ffffffffc02049b0 <commands+0x8b0>
ffffffffc02012e8:	00003617          	auipc	a2,0x3
ffffffffc02012ec:	65860613          	addi	a2,a2,1624 # ffffffffc0204940 <commands+0x840>
ffffffffc02012f0:	0d300593          	li	a1,211
ffffffffc02012f4:	00003517          	auipc	a0,0x3
ffffffffc02012f8:	66450513          	addi	a0,a0,1636 # ffffffffc0204958 <commands+0x858>
ffffffffc02012fc:	95eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201300:	00003697          	auipc	a3,0x3
ffffffffc0201304:	6d068693          	addi	a3,a3,1744 # ffffffffc02049d0 <commands+0x8d0>
ffffffffc0201308:	00003617          	auipc	a2,0x3
ffffffffc020130c:	63860613          	addi	a2,a2,1592 # ffffffffc0204940 <commands+0x840>
ffffffffc0201310:	0bb00593          	li	a1,187
ffffffffc0201314:	00003517          	auipc	a0,0x3
ffffffffc0201318:	64450513          	addi	a0,a0,1604 # ffffffffc0204958 <commands+0x858>
ffffffffc020131c:	93eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(count == 0);
ffffffffc0201320:	00004697          	auipc	a3,0x4
ffffffffc0201324:	95868693          	addi	a3,a3,-1704 # ffffffffc0204c78 <commands+0xb78>
ffffffffc0201328:	00003617          	auipc	a2,0x3
ffffffffc020132c:	61860613          	addi	a2,a2,1560 # ffffffffc0204940 <commands+0x840>
ffffffffc0201330:	12500593          	li	a1,293
ffffffffc0201334:	00003517          	auipc	a0,0x3
ffffffffc0201338:	62450513          	addi	a0,a0,1572 # ffffffffc0204958 <commands+0x858>
ffffffffc020133c:	91eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc0201340:	00003697          	auipc	a3,0x3
ffffffffc0201344:	7d868693          	addi	a3,a3,2008 # ffffffffc0204b18 <commands+0xa18>
ffffffffc0201348:	00003617          	auipc	a2,0x3
ffffffffc020134c:	5f860613          	addi	a2,a2,1528 # ffffffffc0204940 <commands+0x840>
ffffffffc0201350:	11a00593          	li	a1,282
ffffffffc0201354:	00003517          	auipc	a0,0x3
ffffffffc0201358:	60450513          	addi	a0,a0,1540 # ffffffffc0204958 <commands+0x858>
ffffffffc020135c:	8feff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201360:	00003697          	auipc	a3,0x3
ffffffffc0201364:	75868693          	addi	a3,a3,1880 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc0201368:	00003617          	auipc	a2,0x3
ffffffffc020136c:	5d860613          	addi	a2,a2,1496 # ffffffffc0204940 <commands+0x840>
ffffffffc0201370:	11800593          	li	a1,280
ffffffffc0201374:	00003517          	auipc	a0,0x3
ffffffffc0201378:	5e450513          	addi	a0,a0,1508 # ffffffffc0204958 <commands+0x858>
ffffffffc020137c:	8deff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201380:	00003697          	auipc	a3,0x3
ffffffffc0201384:	6f868693          	addi	a3,a3,1784 # ffffffffc0204a78 <commands+0x978>
ffffffffc0201388:	00003617          	auipc	a2,0x3
ffffffffc020138c:	5b860613          	addi	a2,a2,1464 # ffffffffc0204940 <commands+0x840>
ffffffffc0201390:	0c100593          	li	a1,193
ffffffffc0201394:	00003517          	auipc	a0,0x3
ffffffffc0201398:	5c450513          	addi	a0,a0,1476 # ffffffffc0204958 <commands+0x858>
ffffffffc020139c:	8beff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02013a0:	00004697          	auipc	a3,0x4
ffffffffc02013a4:	89868693          	addi	a3,a3,-1896 # ffffffffc0204c38 <commands+0xb38>
ffffffffc02013a8:	00003617          	auipc	a2,0x3
ffffffffc02013ac:	59860613          	addi	a2,a2,1432 # ffffffffc0204940 <commands+0x840>
ffffffffc02013b0:	11200593          	li	a1,274
ffffffffc02013b4:	00003517          	auipc	a0,0x3
ffffffffc02013b8:	5a450513          	addi	a0,a0,1444 # ffffffffc0204958 <commands+0x858>
ffffffffc02013bc:	89eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02013c0:	00004697          	auipc	a3,0x4
ffffffffc02013c4:	85868693          	addi	a3,a3,-1960 # ffffffffc0204c18 <commands+0xb18>
ffffffffc02013c8:	00003617          	auipc	a2,0x3
ffffffffc02013cc:	57860613          	addi	a2,a2,1400 # ffffffffc0204940 <commands+0x840>
ffffffffc02013d0:	11000593          	li	a1,272
ffffffffc02013d4:	00003517          	auipc	a0,0x3
ffffffffc02013d8:	58450513          	addi	a0,a0,1412 # ffffffffc0204958 <commands+0x858>
ffffffffc02013dc:	87eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02013e0:	00004697          	auipc	a3,0x4
ffffffffc02013e4:	81068693          	addi	a3,a3,-2032 # ffffffffc0204bf0 <commands+0xaf0>
ffffffffc02013e8:	00003617          	auipc	a2,0x3
ffffffffc02013ec:	55860613          	addi	a2,a2,1368 # ffffffffc0204940 <commands+0x840>
ffffffffc02013f0:	10e00593          	li	a1,270
ffffffffc02013f4:	00003517          	auipc	a0,0x3
ffffffffc02013f8:	56450513          	addi	a0,a0,1380 # ffffffffc0204958 <commands+0x858>
ffffffffc02013fc:	85eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201400:	00003697          	auipc	a3,0x3
ffffffffc0201404:	7c868693          	addi	a3,a3,1992 # ffffffffc0204bc8 <commands+0xac8>
ffffffffc0201408:	00003617          	auipc	a2,0x3
ffffffffc020140c:	53860613          	addi	a2,a2,1336 # ffffffffc0204940 <commands+0x840>
ffffffffc0201410:	10d00593          	li	a1,269
ffffffffc0201414:	00003517          	auipc	a0,0x3
ffffffffc0201418:	54450513          	addi	a0,a0,1348 # ffffffffc0204958 <commands+0x858>
ffffffffc020141c:	83eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201420:	00003697          	auipc	a3,0x3
ffffffffc0201424:	79868693          	addi	a3,a3,1944 # ffffffffc0204bb8 <commands+0xab8>
ffffffffc0201428:	00003617          	auipc	a2,0x3
ffffffffc020142c:	51860613          	addi	a2,a2,1304 # ffffffffc0204940 <commands+0x840>
ffffffffc0201430:	10800593          	li	a1,264
ffffffffc0201434:	00003517          	auipc	a0,0x3
ffffffffc0201438:	52450513          	addi	a0,a0,1316 # ffffffffc0204958 <commands+0x858>
ffffffffc020143c:	81eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201440:	00003697          	auipc	a3,0x3
ffffffffc0201444:	67868693          	addi	a3,a3,1656 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc0201448:	00003617          	auipc	a2,0x3
ffffffffc020144c:	4f860613          	addi	a2,a2,1272 # ffffffffc0204940 <commands+0x840>
ffffffffc0201450:	10700593          	li	a1,263
ffffffffc0201454:	00003517          	auipc	a0,0x3
ffffffffc0201458:	50450513          	addi	a0,a0,1284 # ffffffffc0204958 <commands+0x858>
ffffffffc020145c:	ffffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201460:	00003697          	auipc	a3,0x3
ffffffffc0201464:	73868693          	addi	a3,a3,1848 # ffffffffc0204b98 <commands+0xa98>
ffffffffc0201468:	00003617          	auipc	a2,0x3
ffffffffc020146c:	4d860613          	addi	a2,a2,1240 # ffffffffc0204940 <commands+0x840>
ffffffffc0201470:	10600593          	li	a1,262
ffffffffc0201474:	00003517          	auipc	a0,0x3
ffffffffc0201478:	4e450513          	addi	a0,a0,1252 # ffffffffc0204958 <commands+0x858>
ffffffffc020147c:	fdffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201480:	00003697          	auipc	a3,0x3
ffffffffc0201484:	6e868693          	addi	a3,a3,1768 # ffffffffc0204b68 <commands+0xa68>
ffffffffc0201488:	00003617          	auipc	a2,0x3
ffffffffc020148c:	4b860613          	addi	a2,a2,1208 # ffffffffc0204940 <commands+0x840>
ffffffffc0201490:	10500593          	li	a1,261
ffffffffc0201494:	00003517          	auipc	a0,0x3
ffffffffc0201498:	4c450513          	addi	a0,a0,1220 # ffffffffc0204958 <commands+0x858>
ffffffffc020149c:	fbffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02014a0:	00003697          	auipc	a3,0x3
ffffffffc02014a4:	6b068693          	addi	a3,a3,1712 # ffffffffc0204b50 <commands+0xa50>
ffffffffc02014a8:	00003617          	auipc	a2,0x3
ffffffffc02014ac:	49860613          	addi	a2,a2,1176 # ffffffffc0204940 <commands+0x840>
ffffffffc02014b0:	10400593          	li	a1,260
ffffffffc02014b4:	00003517          	auipc	a0,0x3
ffffffffc02014b8:	4a450513          	addi	a0,a0,1188 # ffffffffc0204958 <commands+0x858>
ffffffffc02014bc:	f9ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02014c0:	00003697          	auipc	a3,0x3
ffffffffc02014c4:	5f868693          	addi	a3,a3,1528 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc02014c8:	00003617          	auipc	a2,0x3
ffffffffc02014cc:	47860613          	addi	a2,a2,1144 # ffffffffc0204940 <commands+0x840>
ffffffffc02014d0:	0fe00593          	li	a1,254
ffffffffc02014d4:	00003517          	auipc	a0,0x3
ffffffffc02014d8:	48450513          	addi	a0,a0,1156 # ffffffffc0204958 <commands+0x858>
ffffffffc02014dc:	f7ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!PageProperty(p0));
ffffffffc02014e0:	00003697          	auipc	a3,0x3
ffffffffc02014e4:	65868693          	addi	a3,a3,1624 # ffffffffc0204b38 <commands+0xa38>
ffffffffc02014e8:	00003617          	auipc	a2,0x3
ffffffffc02014ec:	45860613          	addi	a2,a2,1112 # ffffffffc0204940 <commands+0x840>
ffffffffc02014f0:	0f900593          	li	a1,249
ffffffffc02014f4:	00003517          	auipc	a0,0x3
ffffffffc02014f8:	46450513          	addi	a0,a0,1124 # ffffffffc0204958 <commands+0x858>
ffffffffc02014fc:	f5ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201500:	00003697          	auipc	a3,0x3
ffffffffc0201504:	75868693          	addi	a3,a3,1880 # ffffffffc0204c58 <commands+0xb58>
ffffffffc0201508:	00003617          	auipc	a2,0x3
ffffffffc020150c:	43860613          	addi	a2,a2,1080 # ffffffffc0204940 <commands+0x840>
ffffffffc0201510:	11700593          	li	a1,279
ffffffffc0201514:	00003517          	auipc	a0,0x3
ffffffffc0201518:	44450513          	addi	a0,a0,1092 # ffffffffc0204958 <commands+0x858>
ffffffffc020151c:	f3ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == 0);
ffffffffc0201520:	00003697          	auipc	a3,0x3
ffffffffc0201524:	76868693          	addi	a3,a3,1896 # ffffffffc0204c88 <commands+0xb88>
ffffffffc0201528:	00003617          	auipc	a2,0x3
ffffffffc020152c:	41860613          	addi	a2,a2,1048 # ffffffffc0204940 <commands+0x840>
ffffffffc0201530:	12600593          	li	a1,294
ffffffffc0201534:	00003517          	auipc	a0,0x3
ffffffffc0201538:	42450513          	addi	a0,a0,1060 # ffffffffc0204958 <commands+0x858>
ffffffffc020153c:	f1ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201540:	00003697          	auipc	a3,0x3
ffffffffc0201544:	43068693          	addi	a3,a3,1072 # ffffffffc0204970 <commands+0x870>
ffffffffc0201548:	00003617          	auipc	a2,0x3
ffffffffc020154c:	3f860613          	addi	a2,a2,1016 # ffffffffc0204940 <commands+0x840>
ffffffffc0201550:	0f300593          	li	a1,243
ffffffffc0201554:	00003517          	auipc	a0,0x3
ffffffffc0201558:	40450513          	addi	a0,a0,1028 # ffffffffc0204958 <commands+0x858>
ffffffffc020155c:	efffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201560:	00003697          	auipc	a3,0x3
ffffffffc0201564:	45068693          	addi	a3,a3,1104 # ffffffffc02049b0 <commands+0x8b0>
ffffffffc0201568:	00003617          	auipc	a2,0x3
ffffffffc020156c:	3d860613          	addi	a2,a2,984 # ffffffffc0204940 <commands+0x840>
ffffffffc0201570:	0ba00593          	li	a1,186
ffffffffc0201574:	00003517          	auipc	a0,0x3
ffffffffc0201578:	3e450513          	addi	a0,a0,996 # ffffffffc0204958 <commands+0x858>
...
ffffffffc02016b0:	5f468693          	addi	a3,a3,1524 # ffffffffc0204ca0 <commands+0xba0>
ffffffffc02016b4:	00003617          	auipc	a2,0x3
ffffffffc02016b8:	28c60613          	addi	a2,a2,652 # ffffffffc0204940 <commands+0x840>
ffffffffc02016bc:	08300593          	li	a1,131
ffffffffc02016c0:	00003517          	auipc	a0,0x3
ffffffffc02016c4:	29850513          	addi	a0,a0,664 # ffffffffc0204958 <commands+0x858>
ffffffffc02016c8:	d93fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc02016cc:	00003697          	auipc	a3,0x3
ffffffffc02016d0:	5cc68693          	addi	a3,a3,1484 # ffffffffc0204c98 <commands+0xb98>
ffffffffc02016d4:	00003617          	auipc	a2,0x3
ffffffffc02016d8:	26c60613          	addi	a2,a2,620 # ffffffffc0204940 <commands+0x840>
ffffffffc02016dc:	08000593          	li	a1,128
ffffffffc02016e0:	00003517          	auipc	a0,0x3
ffffffffc02016e4:	27850513          	addi	a0,a0,632 # ffffffffc0204958 <commands+0x858>
...
ffffffffc0201782:	51a68693          	addi	a3,a3,1306 # ffffffffc0204c98 <commands+0xb98>
ffffffffc0201786:	00003617          	auipc	a2,0x3
ffffffffc020178a:	1ba60613          	addi	a2,a2,442 # ffffffffc0204940 <commands+0x840>
ffffffffc020178e:	06200593          	li	a1,98
ffffffffc0201792:	00003517          	auipc	a0,0x3
ffffffffc0201796:	1c650513          	addi	a0,a0,454 # ffffffffc0204958 <commands+0x858>
default_alloc_pages(size_t n) {
...
ffffffffc0201854:	47868693          	addi	a3,a3,1144 # ffffffffc0204cc8 <commands+0xbc8>
ffffffffc0201858:	00003617          	auipc	a2,0x3
ffffffffc020185c:	0e860613          	addi	a2,a2,232 # ffffffffc0204940 <commands+0x840>
ffffffffc0201860:	04900593          	li	a1,73
ffffffffc0201864:	00003517          	auipc	a0,0x3
ffffffffc0201868:	0f450513          	addi	a0,a0,244 # ffffffffc0204958 <commands+0x858>
ffffffffc020186c:	beffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc0201870:	00003697          	auipc	a3,0x3
ffffffffc0201874:	42868693          	addi	a3,a3,1064 # ffffffffc0204c98 <commands+0xb98>
ffffffffc0201878:	00003617          	auipc	a2,0x3
ffffffffc020187c:	0c860613          	addi	a2,a2,200 # ffffffffc0204940 <commands+0x840>
ffffffffc0201880:	04600593          	li	a1,70
ffffffffc0201884:	00003517          	auipc	a0,0x3
ffffffffc0201888:	0d450513          	addi	a0,a0,212 # ffffffffc0204958 <commands+0x858>
...
ffffffffc0201964:	0a86b683          	ld	a3,168(a3) # ffffffffc0205a08 <nbase>
...
ffffffffc0201994:	39860613          	addi	a2,a2,920 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0201998:	07100593          	li	a1,113
ffffffffc020199c:	00003517          	auipc	a0,0x3
ffffffffc02019a0:	3b450513          	addi	a0,a0,948 # ffffffffc0204d50 <default_pmm_manager+0x60>
...
ffffffffc0201a82:	2e268693          	addi	a3,a3,738 # ffffffffc0204d60 <default_pmm_manager+0x70>
ffffffffc0201a86:	00003617          	auipc	a2,0x3
ffffffffc0201a8a:	eba60613          	addi	a2,a2,-326 # ffffffffc0204940 <commands+0x840>
ffffffffc0201a8e:	06300593          	li	a1,99
ffffffffc0201a92:	00003517          	auipc	a0,0x3
ffffffffc0201a96:	2ee50513          	addi	a0,a0,750 # ffffffffc0204d80 <default_pmm_manager+0x90>
...
ffffffffc0201aa4:	2f850513          	addi	a0,a0,760 # ffffffffc0204d98 <default_pmm_manager+0xa8>
{
...
ffffffffc0201ab4:	30050513          	addi	a0,a0,768 # ffffffffc0204db0 <default_pmm_manager+0xc0>
}
...
ffffffffc0201bd8:	e3453503          	ld	a0,-460(a0) # ffffffffc0205a08 <nbase>
...
ffffffffc0201c36:	1c660613          	addi	a2,a2,454 # ffffffffc0204df8 <default_pmm_manager+0x108>
ffffffffc0201c3a:	06900593          	li	a1,105
ffffffffc0201c3e:	00003517          	auipc	a0,0x3
ffffffffc0201c42:	11250513          	addi	a0,a0,274 # ffffffffc0204d50 <default_pmm_manager+0x60>
...
ffffffffc0201c50:	18460613          	addi	a2,a2,388 # ffffffffc0204dd0 <default_pmm_manager+0xe0>
ffffffffc0201c54:	07700593          	li	a1,119
ffffffffc0201c58:	00003517          	auipc	a0,0x3
ffffffffc0201c5c:	0f850513          	addi	a0,a0,248 # ffffffffc0204d50 <default_pmm_manager+0x60>
...
ffffffffc0201c6a:	19260613          	addi	a2,a2,402 # ffffffffc0204df8 <default_pmm_manager+0x108>
ffffffffc0201c6e:	06900593          	li	a1,105
ffffffffc0201c72:	00003517          	auipc	a0,0x3
ffffffffc0201c76:	0de50513          	addi	a0,a0,222 # ffffffffc0204d50 <default_pmm_manager+0x60>
pa2page(uintptr_t pa)
...
ffffffffc0201c86:	19660613          	addi	a2,a2,406 # ffffffffc0204e18 <default_pmm_manager+0x128>
ffffffffc0201c8a:	07f00593          	li	a1,127
ffffffffc0201c8e:	00003517          	auipc	a0,0x3
ffffffffc0201c92:	0c250513          	addi	a0,a0,194 # ffffffffc0204d50 <default_pmm_manager+0x60>
pte2page(pte_t pte)
...
ffffffffc0201dec:	058020ef          	jal	ra,ffffffffc0203e44 <memset>
    return page - pages + nbase;
...
ffffffffc0201e8e:	7b7010ef          	jal	ra,ffffffffc0203e44 <memset>
    return page - pages + nbase;
...
ffffffffc0201f1c:	e1060613          	addi	a2,a2,-496 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0201f20:	0fb00593          	li	a1,251
ffffffffc0201f24:	00003517          	auipc	a0,0x3
ffffffffc0201f28:	f1c50513          	addi	a0,a0,-228 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0201f2c:	d2efe0ef          	jal	ra,ffffffffc020045a <__panic>
    pde_t *pdep0 = &((pte_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc0201f30:	00003617          	auipc	a2,0x3
ffffffffc0201f34:	df860613          	addi	a2,a2,-520 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0201f38:	0ee00593          	li	a1,238
ffffffffc0201f3c:	00003517          	auipc	a0,0x3
ffffffffc0201f40:	f0450513          	addi	a0,a0,-252 # ffffffffc0204e40 <default_pmm_manager+0x150>
...
ffffffffc0201f4e:	dde60613          	addi	a2,a2,-546 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0201f52:	0eb00593          	li	a1,235
ffffffffc0201f56:	00003517          	auipc	a0,0x3
ffffffffc0201f5a:	eea50513          	addi	a0,a0,-278 # ffffffffc0204e40 <default_pmm_manager+0x150>
...
ffffffffc0201f68:	dc460613          	addi	a2,a2,-572 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0201f6c:	0f800593          	li	a1,248
ffffffffc0201f70:	00003517          	auipc	a0,0x3
ffffffffc0201f74:	ed050513          	addi	a0,a0,-304 # ffffffffc0204e40 <default_pmm_manager+0x150>
...
ffffffffc0202166:	b8e78793          	addi	a5,a5,-1138 # ffffffffc0204cf0 <default_pmm_manager>
...
ffffffffc0202174:	ce050513          	addi	a0,a0,-800 # ffffffffc0204e50 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02021c8:	cc450513          	addi	a0,a0,-828 # ffffffffc0204e88 <default_pmm_manager+0x198>
...
ffffffffc02021e0:	cc450513          	addi	a0,a0,-828 # ffffffffc0204ea0 <default_pmm_manager+0x1b0>
...
ffffffffc0202268:	c6450513          	addi	a0,a0,-924 # ffffffffc0204ec8 <default_pmm_manager+0x1d8>
...
ffffffffc0202284:	c6050513          	addi	a0,a0,-928 # ffffffffc0204ee0 <default_pmm_manager+0x1f0>
...
ffffffffc020253a:	cd250513          	addi	a0,a0,-814 # ffffffffc0205208 <default_pmm_manager+0x518>
...
ffffffffc02025fe:	d5658593          	addi	a1,a1,-682 # ffffffffc0205350 <default_pmm_manager+0x660>
ffffffffc0202602:	10000513          	li	a0,256
ffffffffc0202606:	7d2010ef          	jal	ra,ffffffffc0203dd8 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020260a:	10040593          	addi	a1,s0,256
ffffffffc020260e:	10000513          	li	a0,256
ffffffffc0202612:	7d8010ef          	jal	ra,ffffffffc0203dea <strcmp>
...
ffffffffc0202644:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202648:	75a010ef          	jal	ra,ffffffffc0203da2 <strlen>
...
ffffffffc020270c:	cc050513          	addi	a0,a0,-832 # ffffffffc02053c8 <default_pmm_manager+0x6d8>
...
ffffffffc0202874:	4b860613          	addi	a2,a2,1208 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0202878:	1a400593          	li	a1,420
ffffffffc020287c:	00002517          	auipc	a0,0x2
ffffffffc0202880:	5c450513          	addi	a0,a0,1476 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202884:	bd7fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202888:	00003697          	auipc	a3,0x3
ffffffffc020288c:	9e068693          	addi	a3,a3,-1568 # ffffffffc0205268 <default_pmm_manager+0x578>
ffffffffc0202890:	00002617          	auipc	a2,0x2
ffffffffc0202894:	0b060613          	addi	a2,a2,176 # ffffffffc0204940 <commands+0x840>
ffffffffc0202898:	1a500593          	li	a1,421
ffffffffc020289c:	00002517          	auipc	a0,0x2
ffffffffc02028a0:	5a450513          	addi	a0,a0,1444 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc02028a4:	bb7fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02028a8:	00003697          	auipc	a3,0x3
ffffffffc02028ac:	98068693          	addi	a3,a3,-1664 # ffffffffc0205228 <default_pmm_manager+0x538>
ffffffffc02028b0:	00002617          	auipc	a2,0x2
ffffffffc02028b4:	09060613          	addi	a2,a2,144 # ffffffffc0204940 <commands+0x840>
ffffffffc02028b8:	1a400593          	li	a1,420
ffffffffc02028bc:	00002517          	auipc	a0,0x2
ffffffffc02028c0:	58450513          	addi	a0,a0,1412 # ffffffffc0204e40 <default_pmm_manager+0x150>
...
ffffffffc02028d4:	75068693          	addi	a3,a3,1872 # ffffffffc0205020 <default_pmm_manager+0x330>
ffffffffc02028d8:	00002617          	auipc	a2,0x2
ffffffffc02028dc:	06860613          	addi	a2,a2,104 # ffffffffc0204940 <commands+0x840>
ffffffffc02028e0:	17400593          	li	a1,372
ffffffffc02028e4:	00002517          	auipc	a0,0x2
ffffffffc02028e8:	55c50513          	addi	a0,a0,1372 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc02028ec:	b6ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc02028f0:	00002697          	auipc	a3,0x2
ffffffffc02028f4:	67068693          	addi	a3,a3,1648 # ffffffffc0204f60 <default_pmm_manager+0x270>
ffffffffc02028f8:	00002617          	auipc	a2,0x2
ffffffffc02028fc:	04860613          	addi	a2,a2,72 # ffffffffc0204940 <commands+0x840>
ffffffffc0202900:	16700593          	li	a1,359
ffffffffc0202904:	00002517          	auipc	a0,0x2
ffffffffc0202908:	53c50513          	addi	a0,a0,1340 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc020290c:	b4ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc0202910:	00002697          	auipc	a3,0x2
ffffffffc0202914:	61068693          	addi	a3,a3,1552 # ffffffffc0204f20 <default_pmm_manager+0x230>
ffffffffc0202918:	00002617          	auipc	a2,0x2
ffffffffc020291c:	02860613          	addi	a2,a2,40 # ffffffffc0204940 <commands+0x840>
ffffffffc0202920:	16600593          	li	a1,358
ffffffffc0202924:	00002517          	auipc	a0,0x2
ffffffffc0202928:	51c50513          	addi	a0,a0,1308 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc020292c:	b2ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202930:	00002697          	auipc	a3,0x2
ffffffffc0202934:	5d068693          	addi	a3,a3,1488 # ffffffffc0204f00 <default_pmm_manager+0x210>
ffffffffc0202938:	00002617          	auipc	a2,0x2
ffffffffc020293c:	00860613          	addi	a2,a2,8 # ffffffffc0204940 <commands+0x840>
ffffffffc0202940:	16500593          	li	a1,357
ffffffffc0202944:	00002517          	auipc	a0,0x2
ffffffffc0202948:	4fc50513          	addi	a0,a0,1276 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc020294c:	b0ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202950:	00002617          	auipc	a2,0x2
ffffffffc0202954:	3d860613          	addi	a2,a2,984 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0202958:	07100593          	li	a1,113
ffffffffc020295c:	00002517          	auipc	a0,0x2
ffffffffc0202960:	3f450513          	addi	a0,a0,1012 # ffffffffc0204d50 <default_pmm_manager+0x60>
ffffffffc0202964:	af7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0202968:	00003697          	auipc	a3,0x3
ffffffffc020296c:	84868693          	addi	a3,a3,-1976 # ffffffffc02051b0 <default_pmm_manager+0x4c0>
ffffffffc0202970:	00002617          	auipc	a2,0x2
ffffffffc0202974:	fd060613          	addi	a2,a2,-48 # ffffffffc0204940 <commands+0x840>
ffffffffc0202978:	18d00593          	li	a1,397
ffffffffc020297c:	00002517          	auipc	a0,0x2
ffffffffc0202980:	4c450513          	addi	a0,a0,1220 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202984:	ad7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202988:	00002697          	auipc	a3,0x2
ffffffffc020298c:	7e068693          	addi	a3,a3,2016 # ffffffffc0205168 <default_pmm_manager+0x478>
ffffffffc0202990:	00002617          	auipc	a2,0x2
ffffffffc0202994:	fb060613          	addi	a2,a2,-80 # ffffffffc0204940 <commands+0x840>
ffffffffc0202998:	18b00593          	li	a1,395
ffffffffc020299c:	00002517          	auipc	a0,0x2
ffffffffc02029a0:	4a450513          	addi	a0,a0,1188 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc02029a4:	ab7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02029a8:	00002697          	auipc	a3,0x2
ffffffffc02029ac:	7f068693          	addi	a3,a3,2032 # ffffffffc0205198 <default_pmm_manager+0x4a8>
ffffffffc02029b0:	00002617          	auipc	a2,0x2
ffffffffc02029b4:	f9060613          	addi	a2,a2,-112 # ffffffffc0204940 <commands+0x840>
ffffffffc02029b8:	18a00593          	li	a1,394
ffffffffc02029bc:	00002517          	auipc	a0,0x2
ffffffffc02029c0:	48450513          	addi	a0,a0,1156 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc02029c4:	a97fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc02029c8:	00003697          	auipc	a3,0x3
ffffffffc02029cc:	8b868693          	addi	a3,a3,-1864 # ffffffffc0205280 <default_pmm_manager+0x590>
ffffffffc02029d0:	00002617          	auipc	a2,0x2
ffffffffc02029d4:	f7060613          	addi	a2,a2,-144 # ffffffffc0204940 <commands+0x840>
ffffffffc02029d8:	1a800593          	li	a1,424
ffffffffc02029dc:	00002517          	auipc	a0,0x2
ffffffffc02029e0:	46450513          	addi	a0,a0,1124 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc02029e4:	a77fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc02029e8:	00002697          	auipc	a3,0x2
ffffffffc02029ec:	7f868693          	addi	a3,a3,2040 # ffffffffc02051e0 <default_pmm_manager+0x4f0>
ffffffffc02029f0:	00002617          	auipc	a2,0x2
ffffffffc02029f4:	f5060613          	addi	a2,a2,-176 # ffffffffc0204940 <commands+0x840>
ffffffffc02029f8:	19500593          	li	a1,405
ffffffffc02029fc:	00002517          	auipc	a0,0x2
ffffffffc0202a00:	44450513          	addi	a0,a0,1092 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202a04:	a57fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202a08:	00003697          	auipc	a3,0x3
ffffffffc0202a0c:	8d068693          	addi	a3,a3,-1840 # ffffffffc02052d8 <default_pmm_manager+0x5e8>
ffffffffc0202a10:	00002617          	auipc	a2,0x2
ffffffffc0202a14:	f3060613          	addi	a2,a2,-208 # ffffffffc0204940 <commands+0x840>
ffffffffc0202a18:	1ad00593          	li	a1,429
ffffffffc0202a1c:	00002517          	auipc	a0,0x2
ffffffffc0202a20:	42450513          	addi	a0,a0,1060 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202a24:	a37fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202a28:	00003697          	auipc	a3,0x3
ffffffffc0202a2c:	87068693          	addi	a3,a3,-1936 # ffffffffc0205298 <default_pmm_manager+0x5a8>
ffffffffc0202a30:	00002617          	auipc	a2,0x2
ffffffffc0202a34:	f1060613          	addi	a2,a2,-240 # ffffffffc0204940 <commands+0x840>
ffffffffc0202a38:	1ac00593          	li	a1,428
ffffffffc0202a3c:	00002517          	auipc	a0,0x2
ffffffffc0202a40:	40450513          	addi	a0,a0,1028 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202a44:	a17fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202a48:	00002697          	auipc	a3,0x2
ffffffffc0202a4c:	72068693          	addi	a3,a3,1824 # ffffffffc0205168 <default_pmm_manager+0x478>
ffffffffc0202a50:	00002617          	auipc	a2,0x2
ffffffffc0202a54:	ef060613          	addi	a2,a2,-272 # ffffffffc0204940 <commands+0x840>
ffffffffc0202a58:	18700593          	li	a1,391
ffffffffc0202a5c:	00002517          	auipc	a0,0x2
ffffffffc0202a60:	3e450513          	addi	a0,a0,996 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202a64:	9f7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202a68:	00002697          	auipc	a3,0x2
ffffffffc0202a6c:	5a068693          	addi	a3,a3,1440 # ffffffffc0205008 <default_pmm_manager+0x318>
ffffffffc0202a70:	00002617          	auipc	a2,0x2
ffffffffc0202a74:	ed060613          	addi	a2,a2,-304 # ffffffffc0204940 <commands+0x840>
ffffffffc0202a78:	18600593          	li	a1,390
ffffffffc0202a7c:	00002517          	auipc	a0,0x2
ffffffffc0202a80:	3c450513          	addi	a0,a0,964 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202a84:	9d7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202a88:	00002697          	auipc	a3,0x2
ffffffffc0202a8c:	6f868693          	addi	a3,a3,1784 # ffffffffc0205180 <default_pmm_manager+0x490>
ffffffffc0202a90:	00002617          	auipc	a2,0x2
ffffffffc0202a94:	eb060613          	addi	a2,a2,-336 # ffffffffc0204940 <commands+0x840>
ffffffffc0202a98:	18300593          	li	a1,387
ffffffffc0202a9c:	00002517          	auipc	a0,0x2
ffffffffc0202aa0:	3a450513          	addi	a0,a0,932 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202aa4:	9b7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202aa8:	00002697          	auipc	a3,0x2
ffffffffc0202aac:	54868693          	addi	a3,a3,1352 # ffffffffc0204ff0 <default_pmm_manager+0x300>
ffffffffc0202ab0:	00002617          	auipc	a2,0x2
ffffffffc0202ab4:	e9060613          	addi	a2,a2,-368 # ffffffffc0204940 <commands+0x840>
ffffffffc0202ab8:	18200593          	li	a1,386
ffffffffc0202abc:	00002517          	auipc	a0,0x2
ffffffffc0202ac0:	38450513          	addi	a0,a0,900 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202ac4:	997fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202ac8:	00002697          	auipc	a3,0x2
ffffffffc0202acc:	5c868693          	addi	a3,a3,1480 # ffffffffc0205090 <default_pmm_manager+0x3a0>
ffffffffc0202ad0:	00002617          	auipc	a2,0x2
ffffffffc0202ad4:	e7060613          	addi	a2,a2,-400 # ffffffffc0204940 <commands+0x840>
ffffffffc0202ad8:	18100593          	li	a1,385
ffffffffc0202adc:	00002517          	auipc	a0,0x2
ffffffffc0202ae0:	36450513          	addi	a0,a0,868 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202ae4:	977fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202ae8:	00002697          	auipc	a3,0x2
ffffffffc0202aec:	68068693          	addi	a3,a3,1664 # ffffffffc0205168 <default_pmm_manager+0x478>
ffffffffc0202af0:	00002617          	auipc	a2,0x2
ffffffffc0202af4:	e5060613          	addi	a2,a2,-432 # ffffffffc0204940 <commands+0x840>
ffffffffc0202af8:	18000593          	li	a1,384
ffffffffc0202afc:	00002517          	auipc	a0,0x2
ffffffffc0202b00:	34450513          	addi	a0,a0,836 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202b04:	957fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202b08:	00002697          	auipc	a3,0x2
ffffffffc0202b0c:	64868693          	addi	a3,a3,1608 # ffffffffc0205150 <default_pmm_manager+0x460>
ffffffffc0202b10:	00002617          	auipc	a2,0x2
ffffffffc0202b14:	e3060613          	addi	a2,a2,-464 # ffffffffc0204940 <commands+0x840>
ffffffffc0202b18:	17f00593          	li	a1,383
ffffffffc0202b1c:	00002517          	auipc	a0,0x2
ffffffffc0202b20:	32450513          	addi	a0,a0,804 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202b24:	937fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0202b28:	00002697          	auipc	a3,0x2
ffffffffc0202b2c:	5f868693          	addi	a3,a3,1528 # ffffffffc0205120 <default_pmm_manager+0x430>
ffffffffc0202b30:	00002617          	auipc	a2,0x2
ffffffffc0202b34:	e1060613          	addi	a2,a2,-496 # ffffffffc0204940 <commands+0x840>
ffffffffc0202b38:	17e00593          	li	a1,382
ffffffffc0202b3c:	00002517          	auipc	a0,0x2
ffffffffc0202b40:	30450513          	addi	a0,a0,772 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202b44:	917fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202b48:	00002697          	auipc	a3,0x2
ffffffffc0202b4c:	5c068693          	addi	a3,a3,1472 # ffffffffc0205108 <default_pmm_manager+0x418>
ffffffffc0202b50:	00002617          	auipc	a2,0x2
ffffffffc0202b54:	df060613          	addi	a2,a2,-528 # ffffffffc0204940 <commands+0x840>
ffffffffc0202b58:	17c00593          	li	a1,380
ffffffffc0202b5c:	00002517          	auipc	a0,0x2
ffffffffc0202b60:	2e450513          	addi	a0,a0,740 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202b64:	8f7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc0202b68:	00002697          	auipc	a3,0x2
ffffffffc0202b6c:	58068693          	addi	a3,a3,1408 # ffffffffc02050e8 <default_pmm_manager+0x3f8>
ffffffffc0202b70:	00002617          	auipc	a2,0x2
ffffffffc0202b74:	dd060613          	addi	a2,a2,-560 # ffffffffc0204940 <commands+0x840>
ffffffffc0202b78:	17b00593          	li	a1,379
ffffffffc0202b7c:	00002517          	auipc	a0,0x2
ffffffffc0202b80:	2c450513          	addi	a0,a0,708 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202b84:	8d7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202b88:	00002697          	auipc	a3,0x2
ffffffffc0202b8c:	55068693          	addi	a3,a3,1360 # ffffffffc02050d8 <default_pmm_manager+0x3e8>
ffffffffc0202b90:	00002617          	auipc	a2,0x2
ffffffffc0202b94:	db060613          	addi	a2,a2,-592 # ffffffffc0204940 <commands+0x840>
ffffffffc0202b98:	17a00593          	li	a1,378
ffffffffc0202b9c:	00002517          	auipc	a0,0x2
ffffffffc0202ba0:	2a450513          	addi	a0,a0,676 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202ba4:	8b7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ba8:	00002697          	auipc	a3,0x2
ffffffffc0202bac:	52068693          	addi	a3,a3,1312 # ffffffffc02050c8 <default_pmm_manager+0x3d8>
ffffffffc0202bb0:	00002617          	auipc	a2,0x2
ffffffffc0202bb4:	d9060613          	addi	a2,a2,-624 # ffffffffc0204940 <commands+0x840>
ffffffffc0202bb8:	17900593          	li	a1,377
ffffffffc0202bbc:	00002517          	auipc	a0,0x2
ffffffffc0202bc0:	28450513          	addi	a0,a0,644 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202bc4:	897fd0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("DTB memory info not available");
ffffffffc0202bc8:	00002617          	auipc	a2,0x2
ffffffffc0202bcc:	2a060613          	addi	a2,a2,672 # ffffffffc0204e68 <default_pmm_manager+0x178>
ffffffffc0202bd0:	06400593          	li	a1,100
ffffffffc0202bd4:	00002517          	auipc	a0,0x2
ffffffffc0202bd8:	26c50513          	addi	a0,a0,620 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202bdc:	87ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202be0:	00002697          	auipc	a3,0x2
ffffffffc0202be4:	60068693          	addi	a3,a3,1536 # ffffffffc02051e0 <default_pmm_manager+0x4f0>
ffffffffc0202be8:	00002617          	auipc	a2,0x2
ffffffffc0202bec:	d5860613          	addi	a2,a2,-680 # ffffffffc0204940 <commands+0x840>
ffffffffc0202bf0:	1bf00593          	li	a1,447
ffffffffc0202bf4:	00002517          	auipc	a0,0x2
ffffffffc0202bf8:	24c50513          	addi	a0,a0,588 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202bfc:	85ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202c00:	00002697          	auipc	a3,0x2
ffffffffc0202c04:	49068693          	addi	a3,a3,1168 # ffffffffc0205090 <default_pmm_manager+0x3a0>
ffffffffc0202c08:	00002617          	auipc	a2,0x2
ffffffffc0202c0c:	d3860613          	addi	a2,a2,-712 # ffffffffc0204940 <commands+0x840>
ffffffffc0202c10:	17800593          	li	a1,376
ffffffffc0202c14:	00002517          	auipc	a0,0x2
ffffffffc0202c18:	22c50513          	addi	a0,a0,556 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202c1c:	83ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202c20:	00002697          	auipc	a3,0x2
ffffffffc0202c24:	43068693          	addi	a3,a3,1072 # ffffffffc0205050 <default_pmm_manager+0x360>
ffffffffc0202c28:	00002617          	auipc	a2,0x2
ffffffffc0202c2c:	d1860613          	addi	a2,a2,-744 # ffffffffc0204940 <commands+0x840>
ffffffffc0202c30:	17700593          	li	a1,375
ffffffffc0202c34:	00002517          	auipc	a0,0x2
ffffffffc0202c38:	20c50513          	addi	a0,a0,524 # ffffffffc0204e40 <default_pmm_manager+0x150>
...
ffffffffc0202c46:	0e660613          	addi	a2,a2,230 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0202c4a:	17300593          	li	a1,371
ffffffffc0202c4e:	00002517          	auipc	a0,0x2
ffffffffc0202c52:	1f250513          	addi	a0,a0,498 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202c56:	805fd0ef          	jal	ra,ffffffffc020045a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0202c5a:	00002617          	auipc	a2,0x2
ffffffffc0202c5e:	0ce60613          	addi	a2,a2,206 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0202c62:	17200593          	li	a1,370
ffffffffc0202c66:	00002517          	auipc	a0,0x2
ffffffffc0202c6a:	1da50513          	addi	a0,a0,474 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202c6e:	fecfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202c72:	00002697          	auipc	a3,0x2
ffffffffc0202c76:	39668693          	addi	a3,a3,918 # ffffffffc0205008 <default_pmm_manager+0x318>
ffffffffc0202c7a:	00002617          	auipc	a2,0x2
ffffffffc0202c7e:	cc660613          	addi	a2,a2,-826 # ffffffffc0204940 <commands+0x840>
ffffffffc0202c82:	17000593          	li	a1,368
ffffffffc0202c86:	00002517          	auipc	a0,0x2
ffffffffc0202c8a:	1ba50513          	addi	a0,a0,442 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202c8e:	fccfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202c92:	00002697          	auipc	a3,0x2
ffffffffc0202c96:	35e68693          	addi	a3,a3,862 # ffffffffc0204ff0 <default_pmm_manager+0x300>
ffffffffc0202c9a:	00002617          	auipc	a2,0x2
ffffffffc0202c9e:	ca660613          	addi	a2,a2,-858 # ffffffffc0204940 <commands+0x840>
ffffffffc0202ca2:	16f00593          	li	a1,367
ffffffffc0202ca6:	00002517          	auipc	a0,0x2
ffffffffc0202caa:	19a50513          	addi	a0,a0,410 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202cae:	facfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202cb2:	00002697          	auipc	a3,0x2
ffffffffc0202cb6:	6ee68693          	addi	a3,a3,1774 # ffffffffc02053a0 <default_pmm_manager+0x6b0>
ffffffffc0202cba:	00002617          	auipc	a2,0x2
ffffffffc0202cbe:	c8660613          	addi	a2,a2,-890 # ffffffffc0204940 <commands+0x840>
ffffffffc0202cc2:	1b600593          	li	a1,438
ffffffffc0202cc6:	00002517          	auipc	a0,0x2
ffffffffc0202cca:	17a50513          	addi	a0,a0,378 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202cce:	f8cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202cd2:	00002697          	auipc	a3,0x2
ffffffffc0202cd6:	69668693          	addi	a3,a3,1686 # ffffffffc0205368 <default_pmm_manager+0x678>
ffffffffc0202cda:	00002617          	auipc	a2,0x2
ffffffffc0202cde:	c6660613          	addi	a2,a2,-922 # ffffffffc0204940 <commands+0x840>
ffffffffc0202ce2:	1b300593          	li	a1,435
ffffffffc0202ce6:	00002517          	auipc	a0,0x2
ffffffffc0202cea:	15a50513          	addi	a0,a0,346 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202cee:	f6cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202cf2:	00002697          	auipc	a3,0x2
ffffffffc0202cf6:	64668693          	addi	a3,a3,1606 # ffffffffc0205338 <default_pmm_manager+0x648>
ffffffffc0202cfa:	00002617          	auipc	a2,0x2
ffffffffc0202cfe:	c4660613          	addi	a2,a2,-954 # ffffffffc0204940 <commands+0x840>
ffffffffc0202d02:	1af00593          	li	a1,431
ffffffffc0202d06:	00002517          	auipc	a0,0x2
ffffffffc0202d0a:	13a50513          	addi	a0,a0,314 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202d0e:	f4cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202d12:	00002697          	auipc	a3,0x2
ffffffffc0202d16:	5de68693          	addi	a3,a3,1502 # ffffffffc02052f0 <default_pmm_manager+0x600>
ffffffffc0202d1a:	00002617          	auipc	a2,0x2
ffffffffc0202d1e:	c2660613          	addi	a2,a2,-986 # ffffffffc0204940 <commands+0x840>
ffffffffc0202d22:	1ae00593          	li	a1,430
ffffffffc0202d26:	00002517          	auipc	a0,0x2
ffffffffc0202d2a:	11a50513          	addi	a0,a0,282 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202d2e:	f2cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc0202d32:	00002617          	auipc	a2,0x2
ffffffffc0202d36:	09e60613          	addi	a2,a2,158 # ffffffffc0204dd0 <default_pmm_manager+0xe0>
ffffffffc0202d3a:	0cb00593          	li	a1,203
ffffffffc0202d3e:	00002517          	auipc	a0,0x2
ffffffffc0202d42:	10250513          	addi	a0,a0,258 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202d46:	f14fd0ef          	jal	ra,ffffffffc020045a <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0202d4a:	00002617          	auipc	a2,0x2
ffffffffc0202d4e:	08660613          	addi	a2,a2,134 # ffffffffc0204dd0 <default_pmm_manager+0xe0>
ffffffffc0202d52:	08000593          	li	a1,128
ffffffffc0202d56:	00002517          	auipc	a0,0x2
ffffffffc0202d5a:	0ea50513          	addi	a0,a0,234 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202d5e:	efcfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc0202d62:	00002697          	auipc	a3,0x2
ffffffffc0202d66:	25e68693          	addi	a3,a3,606 # ffffffffc0204fc0 <default_pmm_manager+0x2d0>
ffffffffc0202d6a:	00002617          	auipc	a2,0x2
ffffffffc0202d6e:	bd660613          	addi	a2,a2,-1066 # ffffffffc0204940 <commands+0x840>
ffffffffc0202d72:	16e00593          	li	a1,366
ffffffffc0202d76:	00002517          	auipc	a0,0x2
ffffffffc0202d7a:	0ca50513          	addi	a0,a0,202 # ffffffffc0204e40 <default_pmm_manager+0x150>
ffffffffc0202d7e:	edcfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);
ffffffffc0202d82:	00002697          	auipc	a3,0x2
ffffffffc0202d86:	20e68693          	addi	a3,a3,526 # ffffffffc0204f90 <default_pmm_manager+0x2a0>
ffffffffc0202d8a:	00002617          	auipc	a2,0x2
ffffffffc0202d8e:	bb660613          	addi	a2,a2,-1098 # ffffffffc0204940 <commands+0x840>
ffffffffc0202d92:	16b00593          	li	a1,363
ffffffffc0202d96:	00002517          	auipc	a0,0x2
ffffffffc0202d9a:	0aa50513          	addi	a0,a0,170 # ffffffffc0204e40 <default_pmm_manager+0x150>
...
ffffffffc0202da8:	64468693          	addi	a3,a3,1604 # ffffffffc02053e8 <default_pmm_manager+0x6f8>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	b9460613          	addi	a2,a2,-1132 # ffffffffc0204940 <commands+0x840>
ffffffffc0202db4:	08800593          	li	a1,136
ffffffffc0202db8:	00002517          	auipc	a0,0x2
ffffffffc0202dbc:	65050513          	addi	a0,a0,1616 # ffffffffc0205408 <default_pmm_manager+0x718>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc0202e7a:	5a268693          	addi	a3,a3,1442 # ffffffffc0205418 <default_pmm_manager+0x728>
ffffffffc0202e7e:	00002617          	auipc	a2,0x2
ffffffffc0202e82:	ac260613          	addi	a2,a2,-1342 # ffffffffc0204940 <commands+0x840>
ffffffffc0202e86:	08e00593          	li	a1,142
ffffffffc0202e8a:	00002517          	auipc	a0,0x2
ffffffffc0202e8e:	57e50513          	addi	a0,a0,1406 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0202e92:	dc8fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0202e96:	00002697          	auipc	a3,0x2
ffffffffc0202e9a:	5c268693          	addi	a3,a3,1474 # ffffffffc0205458 <default_pmm_manager+0x768>
ffffffffc0202e9e:	00002617          	auipc	a2,0x2
ffffffffc0202ea2:	aa260613          	addi	a2,a2,-1374 # ffffffffc0204940 <commands+0x840>
ffffffffc0202ea6:	08700593          	li	a1,135
ffffffffc0202eaa:	00002517          	auipc	a0,0x2
ffffffffc0202eae:	55e50513          	addi	a0,a0,1374 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0202eb2:	da8fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0202eb6:	00002697          	auipc	a3,0x2
ffffffffc0202eba:	58268693          	addi	a3,a3,1410 # ffffffffc0205438 <default_pmm_manager+0x748>
ffffffffc0202ebe:	00002617          	auipc	a2,0x2
ffffffffc0202ec2:	a8260613          	addi	a2,a2,-1406 # ffffffffc0204940 <commands+0x840>
ffffffffc0202ec6:	08600593          	li	a1,134
ffffffffc0202eca:	00002517          	auipc	a0,0x2
ffffffffc0202ece:	53e50513          	addi	a0,a0,1342 # ffffffffc0205408 <default_pmm_manager+0x718>
...
ffffffffc0202f34:	6c068693          	addi	a3,a3,1728 # ffffffffc02055f0 <default_pmm_manager+0x900>
ffffffffc0202f38:	00002617          	auipc	a2,0x2
ffffffffc0202f3c:	a0860613          	addi	a2,a2,-1528 # ffffffffc0204940 <commands+0x840>
ffffffffc0202f40:	0da00593          	li	a1,218
ffffffffc0202f44:	00002517          	auipc	a0,0x2
ffffffffc0202f48:	4c450513          	addi	a0,a0,1220 # ffffffffc0205408 <default_pmm_manager+0x718>
...
ffffffffc0202f82:	67268693          	addi	a3,a3,1650 # ffffffffc02055f0 <default_pmm_manager+0x900>
ffffffffc0202f86:	00002617          	auipc	a2,0x2
ffffffffc0202f8a:	9ba60613          	addi	a2,a2,-1606 # ffffffffc0204940 <commands+0x840>
ffffffffc0202f8e:	0e100593          	li	a1,225
ffffffffc0202f92:	00002517          	auipc	a0,0x2
ffffffffc0202f96:	47650513          	addi	a0,a0,1142 # ffffffffc0205408 <default_pmm_manager+0x718>
...
ffffffffc0203056:	52650513          	addi	a0,a0,1318 # ffffffffc0205578 <default_pmm_manager+0x888>
ffffffffc020305a:	93afd0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020305e:	00002697          	auipc	a3,0x2
ffffffffc0203062:	54268693          	addi	a3,a3,1346 # ffffffffc02055a0 <default_pmm_manager+0x8b0>
ffffffffc0203066:	00002617          	auipc	a2,0x2
ffffffffc020306a:	8da60613          	addi	a2,a2,-1830 # ffffffffc0204940 <commands+0x840>
ffffffffc020306e:	10700593          	li	a1,263
ffffffffc0203072:	00002517          	auipc	a0,0x2
ffffffffc0203076:	39650513          	addi	a0,a0,918 # ffffffffc0205408 <default_pmm_manager+0x718>
...
ffffffffc02030a8:	51450513          	addi	a0,a0,1300 # ffffffffc02055b8 <default_pmm_manager+0x8c8>
...
ffffffffc02030c2:	51a50513          	addi	a0,a0,1306 # ffffffffc02055d8 <default_pmm_manager+0x8e8>
}
...
ffffffffc02030d0:	3c468693          	addi	a3,a3,964 # ffffffffc0205490 <default_pmm_manager+0x7a0>
ffffffffc02030d4:	00002617          	auipc	a2,0x2
ffffffffc02030d8:	86c60613          	addi	a2,a2,-1940 # ffffffffc0204940 <commands+0x840>
ffffffffc02030dc:	0eb00593          	li	a1,235
ffffffffc02030e0:	00002517          	auipc	a0,0x2
ffffffffc02030e4:	32850513          	addi	a0,a0,808 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc02030e8:	b72fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc02030ec:	00002697          	auipc	a3,0x2
ffffffffc02030f0:	42c68693          	addi	a3,a3,1068 # ffffffffc0205518 <default_pmm_manager+0x828>
ffffffffc02030f4:	00002617          	auipc	a2,0x2
ffffffffc02030f8:	84c60613          	addi	a2,a2,-1972 # ffffffffc0204940 <commands+0x840>
ffffffffc02030fc:	0fc00593          	li	a1,252
ffffffffc0203100:	00002517          	auipc	a0,0x2
ffffffffc0203104:	30850513          	addi	a0,a0,776 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0203108:	b52fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc020310c:	00002697          	auipc	a3,0x2
ffffffffc0203110:	43c68693          	addi	a3,a3,1084 # ffffffffc0205548 <default_pmm_manager+0x858>
ffffffffc0203114:	00002617          	auipc	a2,0x2
ffffffffc0203118:	82c60613          	addi	a2,a2,-2004 # ffffffffc0204940 <commands+0x840>
ffffffffc020311c:	0fd00593          	li	a1,253
ffffffffc0203120:	00002517          	auipc	a0,0x2
ffffffffc0203124:	2e850513          	addi	a0,a0,744 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0203128:	b32fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc020312c:	00002697          	auipc	a3,0x2
ffffffffc0203130:	34c68693          	addi	a3,a3,844 # ffffffffc0205478 <default_pmm_manager+0x788>
ffffffffc0203134:	00002617          	auipc	a2,0x2
ffffffffc0203138:	80c60613          	addi	a2,a2,-2036 # ffffffffc0204940 <commands+0x840>
ffffffffc020313c:	0e900593          	li	a1,233
ffffffffc0203140:	00002517          	auipc	a0,0x2
ffffffffc0203144:	2c850513          	addi	a0,a0,712 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0203148:	b12fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2 != NULL);
ffffffffc020314c:	00002697          	auipc	a3,0x2
ffffffffc0203150:	38c68693          	addi	a3,a3,908 # ffffffffc02054d8 <default_pmm_manager+0x7e8>
ffffffffc0203154:	00001617          	auipc	a2,0x1
ffffffffc0203158:	7ec60613          	addi	a2,a2,2028 # ffffffffc0204940 <commands+0x840>
ffffffffc020315c:	0f400593          	li	a1,244
ffffffffc0203160:	00002517          	auipc	a0,0x2
ffffffffc0203164:	2a850513          	addi	a0,a0,680 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0203168:	af2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1 != NULL);
ffffffffc020316c:	00002697          	auipc	a3,0x2
ffffffffc0203170:	35c68693          	addi	a3,a3,860 # ffffffffc02054c8 <default_pmm_manager+0x7d8>
ffffffffc0203174:	00001617          	auipc	a2,0x1
ffffffffc0203178:	7cc60613          	addi	a2,a2,1996 # ffffffffc0204940 <commands+0x840>
ffffffffc020317c:	0f200593          	li	a1,242
ffffffffc0203180:	00002517          	auipc	a0,0x2
ffffffffc0203184:	28850513          	addi	a0,a0,648 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc0203188:	ad2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma3 == NULL);
ffffffffc020318c:	00002697          	auipc	a3,0x2
ffffffffc0203190:	35c68693          	addi	a3,a3,860 # ffffffffc02054e8 <default_pmm_manager+0x7f8>
ffffffffc0203194:	00001617          	auipc	a2,0x1
ffffffffc0203198:	7ac60613          	addi	a2,a2,1964 # ffffffffc0204940 <commands+0x840>
ffffffffc020319c:	0f600593          	li	a1,246
ffffffffc02031a0:	00002517          	auipc	a0,0x2
ffffffffc02031a4:	26850513          	addi	a0,a0,616 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc02031a8:	ab2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma5 == NULL);
ffffffffc02031ac:	00002697          	auipc	a3,0x2
ffffffffc02031b0:	35c68693          	addi	a3,a3,860 # ffffffffc0205508 <default_pmm_manager+0x818>
ffffffffc02031b4:	00001617          	auipc	a2,0x1
ffffffffc02031b8:	78c60613          	addi	a2,a2,1932 # ffffffffc0204940 <commands+0x840>
ffffffffc02031bc:	0fa00593          	li	a1,250
ffffffffc02031c0:	00002517          	auipc	a0,0x2
ffffffffc02031c4:	24850513          	addi	a0,a0,584 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc02031c8:	a92fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma4 == NULL);
ffffffffc02031cc:	00002697          	auipc	a3,0x2
ffffffffc02031d0:	32c68693          	addi	a3,a3,812 # ffffffffc02054f8 <default_pmm_manager+0x808>
ffffffffc02031d4:	00001617          	auipc	a2,0x1
ffffffffc02031d8:	76c60613          	addi	a2,a2,1900 # ffffffffc0204940 <commands+0x840>
ffffffffc02031dc:	0f800593          	li	a1,248
ffffffffc02031e0:	00002517          	auipc	a0,0x2
ffffffffc02031e4:	22850513          	addi	a0,a0,552 # ffffffffc0205408 <default_pmm_manager+0x718>
ffffffffc02031e8:	a72fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(mm != NULL);
ffffffffc02031ec:	00002697          	auipc	a3,0x2
ffffffffc02031f0:	41468693          	addi	a3,a3,1044 # ffffffffc0205600 <default_pmm_manager+0x910>
ffffffffc02031f4:	00001617          	auipc	a2,0x1
ffffffffc02031f8:	74c60613          	addi	a2,a2,1868 # ffffffffc0204940 <commands+0x840>
ffffffffc02031fc:	0d200593          	li	a1,210
ffffffffc0203200:	00002517          	auipc	a0,0x2
ffffffffc0203204:	20850513          	addi	a0,a0,520 # ffffffffc0205408 <default_pmm_manager+0x718>
...
ffffffffc020320e:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203210:	3d8000ef          	jal	ra,ffffffffc02035e8 <do_exit>
...
ffffffffc020324a:	3fb000ef          	jal	ra,ffffffffc0203e44 <memset>
...
ffffffffc0203268:	3dd000ef          	jal	ra,ffffffffc0203e44 <memset>
    }
    return proc;
}
...
ffffffffc02032d2:	36a50513          	addi	a0,a0,874 # ffffffffc0205638 <default_pmm_manager+0x948>
ffffffffc02032d6:	ebffc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02032da:	00002517          	auipc	a0,0x2
ffffffffc02032de:	36e50513          	addi	a0,a0,878 # ffffffffc0205648 <default_pmm_manager+0x958>
...
ffffffffc020330a:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc020330c:	02a48863          	beq	s1,a0,ffffffffc020333c <proc_run+0x46>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0203316:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203318:	ef9d                	bnez	a5,ffffffffc0203356 <proc_run+0x60>
            uintptr_t satp_val = ((uintptr_t)SATP_MODE_SV39 << 60) | (next->pgdir >> RISCV_PGSHIFT);
ffffffffc020331a:	755c                	ld	a5,168(a0)
ffffffffc020331c:	577d                	li	a4,-1
ffffffffc020331e:	177e                	slli	a4,a4,0x3f
ffffffffc0203320:	83b1                	srli	a5,a5,0xc
            current = proc;
ffffffffc0203322:	00a93023          	sd	a0,0(s2)
            uintptr_t satp_val = ((uintptr_t)SATP_MODE_SV39 << 60) | (next->pgdir >> RISCV_PGSHIFT);
ffffffffc0203326:	8fd9                	or	a5,a5,a4
            write_csr(satp, satp_val);
ffffffffc0203328:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context));
ffffffffc020332c:	03050593          	addi	a1,a0,48
ffffffffc0203330:	03048513          	addi	a0,s1,48
ffffffffc0203334:	53a000ef          	jal	ra,ffffffffc020386e <switch_to>
    if (flag) {
ffffffffc0203338:	00099863          	bnez	s3,ffffffffc0203348 <proc_run+0x52>
}
ffffffffc020333c:	70a2                	ld	ra,40(sp)
ffffffffc020333e:	7482                	ld	s1,32(sp)
ffffffffc0203340:	6962                	ld	s2,24(sp)
ffffffffc0203342:	69c2                	ld	s3,16(sp)
ffffffffc0203344:	6145                	addi	sp,sp,48
ffffffffc0203346:	8082                	ret
ffffffffc0203348:	70a2                	ld	ra,40(sp)
ffffffffc020334a:	7482                	ld	s1,32(sp)
ffffffffc020334c:	6962                	ld	s2,24(sp)
ffffffffc020334e:	69c2                	ld	s3,16(sp)
ffffffffc0203350:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0203352:	dd8fd06f          	j	ffffffffc020092a <intr_enable>
ffffffffc0203356:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0203358:	dd8fd0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc020335c:	6522                	ld	a0,8(sp)
ffffffffc020335e:	4985                	li	s3,1
ffffffffc0203360:	bf6d                	j	ffffffffc020331a <proc_run+0x24>

ffffffffc0203362 <do_fork>:
{
ffffffffc0203362:	7179                	addi	sp,sp,-48
ffffffffc0203364:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0203366:	0000a917          	auipc	s2,0xa
ffffffffc020336a:	18290913          	addi	s2,s2,386 # ffffffffc020d4e8 <nr_process>
ffffffffc020336e:	00092703          	lw	a4,0(s2)
{
...
ffffffffc020337c:	1cf75b63          	bge	a4,a5,ffffffffc0203552 <do_fork+0x1f0>
ffffffffc0203380:	84ae                	mv	s1,a1
ffffffffc0203382:	8432                	mv	s0,a2
    proc = alloc_proc();
ffffffffc0203384:	e91ff0ef          	jal	ra,ffffffffc0203214 <alloc_proc>
ffffffffc0203388:	89aa                	mv	s3,a0
    if (proc == NULL) {
ffffffffc020338a:	1c050963          	beqz	a0,ffffffffc020355c <do_fork+0x1fa>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020338e:	4509                	li	a0,2
ffffffffc0203390:	90dfe0ef          	jal	ra,ffffffffc0201c9c <alloc_pages>
    if (page != NULL)
ffffffffc0203394:	1a050a63          	beqz	a0,ffffffffc0203548 <do_fork+0x1e6>
    return page - pages + nbase;
...
ffffffffc02033aa:	66263603          	ld	a2,1634(a2) # ffffffffc0205a08 <nbase>
ffffffffc02033ae:	96b2                	add	a3,a3,a2
    return KADDR(page2pa(page));
...
ffffffffc02033be:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02033c0:	1ce7f063          	bgeu	a5,a4,ffffffffc0203580 <do_fork+0x21e>
    assert(current->mm == NULL);
ffffffffc02033c4:	0000a717          	auipc	a4,0xa
ffffffffc02033c8:	10c73703          	ld	a4,268(a4) # ffffffffc020d4d0 <current>
ffffffffc02033cc:	771c                	ld	a5,40(a4)
ffffffffc02033ce:	0000a617          	auipc	a2,0xa
ffffffffc02033d2:	0fa63603          	ld	a2,250(a2) # ffffffffc020d4c8 <va_pa_offset>
ffffffffc02033d6:	9636                	add	a2,a2,a3
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02033d8:	00c9b823          	sd	a2,16(s3)
    assert(current->mm == NULL);
ffffffffc02033dc:	18079263          	bnez	a5,ffffffffc0203560 <do_fork+0x1fe>
    if (++last_pid >= MAX_PID)
ffffffffc02033e0:	00006e17          	auipc	t3,0x6
ffffffffc02033e4:	c48e0e13          	addi	t3,t3,-952 # ffffffffc0209028 <last_pid.1>
ffffffffc02033e8:	000e2783          	lw	a5,0(t3)
ffffffffc02033ec:	0000a817          	auipc	a6,0xa
ffffffffc02033f0:	06c80813          	addi	a6,a6,108 # ffffffffc020d458 <proc_list>
    proc->parent = current;
ffffffffc02033f4:	02e9b023          	sd	a4,32(s3)
    if (++last_pid >= MAX_PID)
ffffffffc02033f8:	0017851b          	addiw	a0,a5,1
ffffffffc02033fc:	00ae2023          	sw	a0,0(t3)
ffffffffc0203400:	6789                	lui	a5,0x2
ffffffffc0203402:	00883303          	ld	t1,8(a6)
ffffffffc0203406:	0cf55263          	bge	a0,a5,ffffffffc02034ca <do_fork+0x168>
    if (last_pid >= next_safe)
ffffffffc020340a:	00006f17          	auipc	t5,0x6
ffffffffc020340e:	c22f0f13          	addi	t5,t5,-990 # ffffffffc020902c <next_safe.0>
ffffffffc0203412:	000f2783          	lw	a5,0(t5)
ffffffffc0203416:	0cf55263          	bge	a0,a5,ffffffffc02034da <do_fork+0x178>
...
ffffffffc0203420:	96b2                	add	a3,a3,a2
    proc->pid = get_pid();
ffffffffc0203422:	00a9a223          	sw	a0,4(s3)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0203426:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc020342a:	87b6                	mv	a5,a3
ffffffffc020342c:	12040e13          	addi	t3,s0,288
ffffffffc0203430:	00043883          	ld	a7,0(s0)
ffffffffc0203434:	640c                	ld	a1,8(s0)
ffffffffc0203436:	6810                	ld	a2,16(s0)
ffffffffc0203438:	6c18                	ld	a4,24(s0)
ffffffffc020343a:	0117b023          	sd	a7,0(a5) # 2000 <kern_entry-0xffffffffc01fe000>
ffffffffc020343e:	e78c                	sd	a1,8(a5)
ffffffffc0203440:	eb90                	sd	a2,16(a5)
ffffffffc0203442:	ef98                	sd	a4,24(a5)
ffffffffc0203444:	02040413          	addi	s0,s0,32
ffffffffc0203448:	02078793          	addi	a5,a5,32
ffffffffc020344c:	ffc412e3          	bne	s0,t3,ffffffffc0203430 <do_fork+0xce>
    proc->tf->gpr.a0 = 0;
ffffffffc0203450:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203454:	cce9                	beqz	s1,ffffffffc020352e <do_fork+0x1cc>
ffffffffc0203456:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203458:	00000797          	auipc	a5,0x0
ffffffffc020345c:	e1e78793          	addi	a5,a5,-482 # ffffffffc0203276 <forkret>
ffffffffc0203460:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0203464:	02d9bc23          	sd	a3,56(s3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0203468:	0c898793          	addi	a5,s3,200
    prev->next = next->prev = elm;
ffffffffc020346c:	00f33023          	sd	a5,0(t1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203470:	45a9                	li	a1,10
    elm->next = next;
ffffffffc0203472:	0c69b823          	sd	t1,208(s3)
    elm->prev = prev;
ffffffffc0203476:	0d09b423          	sd	a6,200(s3)
ffffffffc020347a:	2501                	sext.w	a0,a0
    prev->next = next->prev = elm;
ffffffffc020347c:	00f83423          	sd	a5,8(a6)
ffffffffc0203480:	51e000ef          	jal	ra,ffffffffc020399e <hash32>
ffffffffc0203484:	02051793          	slli	a5,a0,0x20
ffffffffc0203488:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020348c:	00006797          	auipc	a5,0x6
ffffffffc0203490:	fbc78793          	addi	a5,a5,-68 # ffffffffc0209448 <hash_list>
ffffffffc0203494:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0203496:	6518                	ld	a4,8(a0)
    nr_process++;
ffffffffc0203498:	00092783          	lw	a5,0(s2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020349c:	0d898693          	addi	a3,s3,216
    prev->next = next->prev = elm;
ffffffffc02034a0:	e314                	sd	a3,0(a4)
ffffffffc02034a2:	e514                	sd	a3,8(a0)
    nr_process++;
ffffffffc02034a4:	2785                	addiw	a5,a5,1
    elm->prev = prev;
ffffffffc02034a6:	0ca9bc23          	sd	a0,216(s3)
    elm->next = next;
ffffffffc02034aa:	0ee9b023          	sd	a4,224(s3)
    wakeup_proc(proc);
ffffffffc02034ae:	854e                	mv	a0,s3
    nr_process++;
ffffffffc02034b0:	00f92023          	sw	a5,0(s2)
    wakeup_proc(proc);
ffffffffc02034b4:	424000ef          	jal	ra,ffffffffc02038d8 <wakeup_proc>
    ret = proc->pid;
ffffffffc02034b8:	0049a503          	lw	a0,4(s3)
}
ffffffffc02034bc:	70a2                	ld	ra,40(sp)
...
ffffffffc02034c8:	8082                	ret
        last_pid = 1;
ffffffffc02034ca:	4785                	li	a5,1
ffffffffc02034cc:	00fe2023          	sw	a5,0(t3)
        goto inside;
ffffffffc02034d0:	4505                	li	a0,1
ffffffffc02034d2:	00006f17          	auipc	t5,0x6
ffffffffc02034d6:	b5af0f13          	addi	t5,t5,-1190 # ffffffffc020902c <next_safe.0>
        next_safe = MAX_PID;
ffffffffc02034da:	6789                	lui	a5,0x2
ffffffffc02034dc:	00ff2023          	sw	a5,0(t5)
ffffffffc02034e0:	86aa                	mv	a3,a0
ffffffffc02034e2:	4881                	li	a7,0
        while ((le = list_next(le)) != list)
ffffffffc02034e4:	6f89                	lui	t6,0x2
ffffffffc02034e6:	05030b63          	beq	t1,a6,ffffffffc020353c <do_fork+0x1da>
ffffffffc02034ea:	8ec6                	mv	t4,a7
ffffffffc02034ec:	879a                	mv	a5,t1
ffffffffc02034ee:	6589                	lui	a1,0x2
ffffffffc02034f0:	a811                	j	ffffffffc0203504 <do_fork+0x1a2>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc02034f2:	00e6d663          	bge	a3,a4,ffffffffc02034fe <do_fork+0x19c>
ffffffffc02034f6:	00b75463          	bge	a4,a1,ffffffffc02034fe <do_fork+0x19c>
ffffffffc02034fa:	85ba                	mv	a1,a4
ffffffffc02034fc:	4e85                	li	t4,1
    return listelm->next;
ffffffffc02034fe:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203500:	01078d63          	beq	a5,a6,ffffffffc020351a <do_fork+0x1b8>
            if (proc->pid == last_pid)
ffffffffc0203504:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0203508:	fed715e3          	bne	a4,a3,ffffffffc02034f2 <do_fork+0x190>
                if (++last_pid >= next_safe)
ffffffffc020350c:	2685                	addiw	a3,a3,1
ffffffffc020350e:	02b6d263          	bge	a3,a1,ffffffffc0203532 <do_fork+0x1d0>
ffffffffc0203512:	679c                	ld	a5,8(a5)
ffffffffc0203514:	4885                	li	a7,1
        while ((le = list_next(le)) != list)
ffffffffc0203516:	ff0797e3          	bne	a5,a6,ffffffffc0203504 <do_fork+0x1a2>
ffffffffc020351a:	00088563          	beqz	a7,ffffffffc0203524 <do_fork+0x1c2>
ffffffffc020351e:	00de2023          	sw	a3,0(t3)
ffffffffc0203522:	8536                	mv	a0,a3
ffffffffc0203524:	ee0e8be3          	beqz	t4,ffffffffc020341a <do_fork+0xb8>
ffffffffc0203528:	00bf2023          	sw	a1,0(t5)
ffffffffc020352c:	b5fd                	j	ffffffffc020341a <do_fork+0xb8>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020352e:	84b6                	mv	s1,a3
ffffffffc0203530:	b71d                	j	ffffffffc0203456 <do_fork+0xf4>
                    if (last_pid >= MAX_PID)
ffffffffc0203532:	01f6c363          	blt	a3,t6,ffffffffc0203538 <do_fork+0x1d6>
                        last_pid = 1;
ffffffffc0203536:	4685                	li	a3,1
                    goto repeat;
ffffffffc0203538:	4885                	li	a7,1
ffffffffc020353a:	b775                	j	ffffffffc02034e6 <do_fork+0x184>
ffffffffc020353c:	00088d63          	beqz	a7,ffffffffc0203556 <do_fork+0x1f4>
ffffffffc0203540:	00de2023          	sw	a3,0(t3)
    return last_pid;
ffffffffc0203544:	8536                	mv	a0,a3
ffffffffc0203546:	bdd1                	j	ffffffffc020341a <do_fork+0xb8>
    kfree(proc);
ffffffffc0203548:	854e                	mv	a0,s3
ffffffffc020354a:	e24fe0ef          	jal	ra,ffffffffc0201b6e <kfree>
    ret = -E_NO_MEM;
ffffffffc020354e:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0203550:	b7b5                	j	ffffffffc02034bc <do_fork+0x15a>
    int ret = -E_NO_FREE_PROC;
ffffffffc0203552:	556d                	li	a0,-5
ffffffffc0203554:	b7a5                	j	ffffffffc02034bc <do_fork+0x15a>
    return last_pid;
ffffffffc0203556:	000e2503          	lw	a0,0(t3)
ffffffffc020355a:	b5c1                	j	ffffffffc020341a <do_fork+0xb8>
    ret = -E_NO_MEM;
ffffffffc020355c:	5571                	li	a0,-4
    return ret;
ffffffffc020355e:	bfb9                	j	ffffffffc02034bc <do_fork+0x15a>
    assert(current->mm == NULL);
ffffffffc0203560:	00002697          	auipc	a3,0x2
ffffffffc0203564:	10868693          	addi	a3,a3,264 # ffffffffc0205668 <default_pmm_manager+0x978>
ffffffffc0203568:	00001617          	auipc	a2,0x1
ffffffffc020356c:	3d860613          	addi	a2,a2,984 # ffffffffc0204940 <commands+0x840>
ffffffffc0203570:	11f00593          	li	a1,287
ffffffffc0203574:	00002517          	auipc	a0,0x2
ffffffffc0203578:	10c50513          	addi	a0,a0,268 # ffffffffc0205680 <default_pmm_manager+0x990>
ffffffffc020357c:	edffc0ef          	jal	ra,ffffffffc020045a <__panic>
ffffffffc0203580:	00001617          	auipc	a2,0x1
ffffffffc0203584:	7a860613          	addi	a2,a2,1960 # ffffffffc0204d28 <default_pmm_manager+0x38>
ffffffffc0203588:	07100593          	li	a1,113
ffffffffc020358c:	00001517          	auipc	a0,0x1
ffffffffc0203590:	7c450513          	addi	a0,a0,1988 # ffffffffc0204d50 <default_pmm_manager+0x60>
...
ffffffffc02035a2:	892a                	mv	s2,a0
ffffffffc02035a4:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035a6:	4581                	li	a1,0
ffffffffc02035a8:	12000613          	li	a2,288
ffffffffc02035ac:	850a                	mv	a0,sp
{
ffffffffc02035ae:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035b0:	095000ef          	jal	ra,ffffffffc0203e44 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02035b4:	e0ca                	sd	s2,64(sp)
...
ffffffffc02035c4:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035c6:	860a                	mv	a2,sp
ffffffffc02035c8:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035cc:	00000797          	auipc	a5,0x0
ffffffffc02035d0:	c4078793          	addi	a5,a5,-960 # ffffffffc020320c <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035d4:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035d6:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035d8:	d8bff0ef          	jal	ra,ffffffffc0203362 <do_fork>
}
...
ffffffffc02035ee:	0ae60613          	addi	a2,a2,174 # ffffffffc0205698 <default_pmm_manager+0x9a8>
ffffffffc02035f2:	17e00593          	li	a1,382
ffffffffc02035f6:	00002517          	auipc	a0,0x2
ffffffffc02035fa:	08a50513          	addi	a0,a0,138 # ffffffffc0205680 <default_pmm_manager+0x990>
{
ffffffffc02035fe:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0203600:	e5bfc0ef          	jal	ra,ffffffffc020045a <__panic>
...
ffffffffc020361c:	e3048493          	addi	s1,s1,-464 # ffffffffc0209448 <hash_list>
...
ffffffffc0203628:	e2470713          	addi	a4,a4,-476 # ffffffffc020d448 <name.2>
...
ffffffffc0203634:	fef71de3          	bne	a4,a5,ffffffffc020362e <proc_init+0x2a>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0203638:	bddff0ef          	jal	ra,ffffffffc0203214 <alloc_proc>
ffffffffc020363c:	0000a917          	auipc	s2,0xa
ffffffffc0203640:	e9c90913          	addi	s2,s2,-356 # ffffffffc020d4d8 <idleproc>
ffffffffc0203644:	00a93023          	sd	a0,0(s2)
ffffffffc0203648:	18050d63          	beqz	a0,ffffffffc02037e2 <proc_init+0x1de>
    {
...
ffffffffc0203650:	c6efe0ef          	jal	ra,ffffffffc0201abe <kmalloc>
...
ffffffffc020365a:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020365c:	7e8000ef          	jal	ra,ffffffffc0203e44 <memset>
...
ffffffffc020366e:	001000ef          	jal	ra,ffffffffc0203e6e <memcmp>
ffffffffc0203672:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203674:	453d                	li	a0,15
ffffffffc0203676:	c48fe0ef          	jal	ra,ffffffffc0201abe <kmalloc>
...
ffffffffc020367e:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203680:	7c4000ef          	jal	ra,ffffffffc0203e44 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0203684:	00093503          	ld	a0,0(s2)
ffffffffc0203688:	463d                	li	a2,15
ffffffffc020368a:	85a2                	mv	a1,s0
ffffffffc020368c:	0b450513          	addi	a0,a0,180
ffffffffc0203690:	7de000ef          	jal	ra,ffffffffc0203e6e <memcmp>
...
ffffffffc020369c:	e0873703          	ld	a4,-504(a4) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc02036a0:	77d4                	ld	a3,168(a5)
ffffffffc02036a2:	0ee68463          	beq	a3,a4,ffffffffc020378a <proc_init+0x186>
    {
...
ffffffffc02036c2:	782000ef          	jal	ra,ffffffffc0203e44 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02036c6:	463d                	li	a2,15
ffffffffc02036c8:	00002597          	auipc	a1,0x2
ffffffffc02036cc:	01858593          	addi	a1,a1,24 # ffffffffc02056e0 <default_pmm_manager+0x9f0>
ffffffffc02036d0:	8522                	mv	a0,s0
ffffffffc02036d2:	784000ef          	jal	ra,ffffffffc0203e56 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc02036d6:	0000a717          	auipc	a4,0xa
ffffffffc02036da:	e1270713          	addi	a4,a4,-494 # ffffffffc020d4e8 <nr_process>
ffffffffc02036de:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02036e0:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036e4:	4601                	li	a2,0
    nr_process++;
ffffffffc02036e6:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036e8:	00002597          	auipc	a1,0x2
ffffffffc02036ec:	00058593          	mv	a1,a1
ffffffffc02036f0:	00000517          	auipc	a0,0x0
ffffffffc02036f4:	b9450513          	addi	a0,a0,-1132 # ffffffffc0203284 <init_main>
    nr_process++;
ffffffffc02036f8:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02036fa:	0000a797          	auipc	a5,0xa
ffffffffc02036fe:	dcd7bb23          	sd	a3,-554(a5) # ffffffffc020d4d0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0203702:	e97ff0ef          	jal	ra,ffffffffc0203598 <kernel_thread>
ffffffffc0203706:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0203708:	0ea05963          	blez	a0,ffffffffc02037fa <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc020370c:	6789                	lui	a5,0x2
ffffffffc020370e:	fff5071b          	addiw	a4,a0,-1
ffffffffc0203712:	17f9                	addi	a5,a5,-2
ffffffffc0203714:	2501                	sext.w	a0,a0
ffffffffc0203716:	02e7e363          	bltu	a5,a4,ffffffffc020373c <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020371a:	45a9                	li	a1,10
ffffffffc020371c:	282000ef          	jal	ra,ffffffffc020399e <hash32>
ffffffffc0203720:	02051793          	slli	a5,a0,0x20
ffffffffc0203724:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0203728:	96a6                	add	a3,a3,s1
ffffffffc020372a:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc020372c:	a029                	j	ffffffffc0203736 <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc020372e:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0203732:	0a870563          	beq	a4,s0,ffffffffc02037dc <proc_init+0x1d8>
    return listelm->next;
ffffffffc0203736:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203738:	fef69be3          	bne	a3,a5,ffffffffc020372e <proc_init+0x12a>
    return NULL;
ffffffffc020373c:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020373e:	0b478493          	addi	s1,a5,180
...
ffffffffc0203746:	0000a417          	auipc	s0,0xa
ffffffffc020374a:	d9a40413          	addi	s0,s0,-614 # ffffffffc020d4e0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020374e:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0203750:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203752:	6f2000ef          	jal	ra,ffffffffc0203e44 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0203756:	463d                	li	a2,15
ffffffffc0203758:	00002597          	auipc	a1,0x2
ffffffffc020375c:	fc058593          	addi	a1,a1,-64 # ffffffffc0205718 <default_pmm_manager+0xa28>
ffffffffc0203760:	8526                	mv	a0,s1
ffffffffc0203762:	6f4000ef          	jal	ra,ffffffffc0203e56 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0203766:	00093783          	ld	a5,0(s2)
ffffffffc020376a:	c7e1                	beqz	a5,ffffffffc0203832 <proc_init+0x22e>
ffffffffc020376c:	43dc                	lw	a5,4(a5)
ffffffffc020376e:	e3f1                	bnez	a5,ffffffffc0203832 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203770:	601c                	ld	a5,0(s0)
ffffffffc0203772:	c3c5                	beqz	a5,ffffffffc0203812 <proc_init+0x20e>
ffffffffc0203774:	43d8                	lw	a4,4(a5)
ffffffffc0203776:	4785                	li	a5,1
ffffffffc0203778:	08f71d63          	bne	a4,a5,ffffffffc0203812 <proc_init+0x20e>
}
ffffffffc020377c:	70a2                	ld	ra,40(sp)
ffffffffc020377e:	7402                	ld	s0,32(sp)
ffffffffc0203780:	64e2                	ld	s1,24(sp)
ffffffffc0203782:	6942                	ld	s2,16(sp)
ffffffffc0203784:	69a2                	ld	s3,8(sp)
ffffffffc0203786:	6145                	addi	sp,sp,48
ffffffffc0203788:	8082                	ret
    if (idleproc->pgdir == boot_pgdir_pa && idleproc->tf == NULL && !context_init_flag && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0 && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag)
ffffffffc020378a:	73d8                	ld	a4,160(a5)
ffffffffc020378c:	ff09                	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc020378e:	f0099ce3          	bnez	s3,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc0203792:	6394                	ld	a3,0(a5)
ffffffffc0203794:	577d                	li	a4,-1
ffffffffc0203796:	1702                	slli	a4,a4,0x20
ffffffffc0203798:	f0e697e3          	bne	a3,a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc020379c:	4798                	lw	a4,8(a5)
ffffffffc020379e:	f00714e3          	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc02037a2:	6b98                	ld	a4,16(a5)
ffffffffc02037a4:	f00711e3          	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc02037a8:	4f98                	lw	a4,24(a5)
ffffffffc02037aa:	2701                	sext.w	a4,a4
ffffffffc02037ac:	ee071de3          	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc02037b0:	7398                	ld	a4,32(a5)
ffffffffc02037b2:	ee071ae3          	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc02037b6:	7798                	ld	a4,40(a5)
ffffffffc02037b8:	ee0717e3          	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
ffffffffc02037bc:	0b07a703          	lw	a4,176(a5)
ffffffffc02037c0:	8d59                	or	a0,a0,a4
ffffffffc02037c2:	0005071b          	sext.w	a4,a0
ffffffffc02037c6:	ee0710e3          	bnez	a4,ffffffffc02036a6 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02037ca:	00002517          	auipc	a0,0x2
ffffffffc02037ce:	efe50513          	addi	a0,a0,-258 # ffffffffc02056c8 <default_pmm_manager+0x9d8>
ffffffffc02037d2:	9c3fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;
ffffffffc02037d6:	00093783          	ld	a5,0(s2)
ffffffffc02037da:	b5f1                	j	ffffffffc02036a6 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02037dc:	f2878793          	addi	a5,a5,-216
ffffffffc02037e0:	bfb9                	j	ffffffffc020373e <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02037e2:	00002617          	auipc	a2,0x2
ffffffffc02037e6:	ece60613          	addi	a2,a2,-306 # ffffffffc02056b0 <default_pmm_manager+0x9c0>
ffffffffc02037ea:	19900593          	li	a1,409
ffffffffc02037ee:	00002517          	auipc	a0,0x2
ffffffffc02037f2:	e9250513          	addi	a0,a0,-366 # ffffffffc0205680 <default_pmm_manager+0x990>
ffffffffc02037f6:	c65fc0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("create init_main failed.\n");
ffffffffc02037fa:	00002617          	auipc	a2,0x2
ffffffffc02037fe:	efe60613          	addi	a2,a2,-258 # ffffffffc02056f8 <default_pmm_manager+0xa08>
ffffffffc0203802:	1b600593          	li	a1,438
ffffffffc0203806:	00002517          	auipc	a0,0x2
ffffffffc020380a:	e7a50513          	addi	a0,a0,-390 # ffffffffc0205680 <default_pmm_manager+0x990>
ffffffffc020380e:	c4dfc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203812:	00002697          	auipc	a3,0x2
ffffffffc0203816:	f3668693          	addi	a3,a3,-202 # ffffffffc0205748 <default_pmm_manager+0xa58>
ffffffffc020381a:	00001617          	auipc	a2,0x1
ffffffffc020381e:	12660613          	addi	a2,a2,294 # ffffffffc0204940 <commands+0x840>
ffffffffc0203822:	1bd00593          	li	a1,445
ffffffffc0203826:	00002517          	auipc	a0,0x2
ffffffffc020382a:	e5a50513          	addi	a0,a0,-422 # ffffffffc0205680 <default_pmm_manager+0x990>
ffffffffc020382e:	c2dfc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0203832:	00002697          	auipc	a3,0x2
ffffffffc0203836:	eee68693          	addi	a3,a3,-274 # ffffffffc0205720 <default_pmm_manager+0xa30>
ffffffffc020383a:	00001617          	auipc	a2,0x1
ffffffffc020383e:	10660613          	addi	a2,a2,262 # ffffffffc0204940 <commands+0x840>
ffffffffc0203842:	1bc00593          	li	a1,444
ffffffffc0203846:	00002517          	auipc	a0,0x2
ffffffffc020384a:	e3a50513          	addi	a0,a0,-454 # ffffffffc0205680 <default_pmm_manager+0x990>
ffffffffc020384e:	c0dfc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc0203852 <cpu_idle>:
...
ffffffffc0203856:	e406                	sd	ra,8(sp)
ffffffffc0203858:	0000a417          	auipc	s0,0xa
ffffffffc020385c:	c7840413          	addi	s0,s0,-904 # ffffffffc020d4d0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc0203860:	6018                	ld	a4,0(s0)
ffffffffc0203862:	4f1c                	lw	a5,24(a4)
ffffffffc0203864:	2781                	sext.w	a5,a5
ffffffffc0203866:	dff5                	beqz	a5,ffffffffc0203862 <cpu_idle+0x10>
        {
            schedule();
ffffffffc0203868:	0a2000ef          	jal	ra,ffffffffc020390a <schedule>
ffffffffc020386c:	bfd5                	j	ffffffffc0203860 <cpu_idle+0xe>

ffffffffc020386e <switch_to>:
.text
...
ffffffffc020386e:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0203872:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0203876:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0203878:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020387a:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020387e:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0203882:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0203886:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020388a:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020388e:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0203892:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0203896:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020389a:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020389e:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02038a2:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02038a6:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02038aa:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02038ac:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02038ae:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02038b2:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02038b6:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02038ba:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02038be:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02038c2:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02038c6:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02038ca:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02038ce:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02038d2:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02038d6:	8082                	ret

ffffffffc02038d8 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02038d8:	411c                	lw	a5,0(a0)
ffffffffc02038da:	4705                	li	a4,1
ffffffffc02038dc:	37f9                	addiw	a5,a5,-2
ffffffffc02038de:	00f77563          	bgeu	a4,a5,ffffffffc02038e8 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02038e2:	4789                	li	a5,2
ffffffffc02038e4:	c11c                	sw	a5,0(a0)
ffffffffc02038e6:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02038e8:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02038ea:	00002697          	auipc	a3,0x2
ffffffffc02038ee:	e8668693          	addi	a3,a3,-378 # ffffffffc0205770 <default_pmm_manager+0xa80>
ffffffffc02038f2:	00001617          	auipc	a2,0x1
ffffffffc02038f6:	04e60613          	addi	a2,a2,78 # ffffffffc0204940 <commands+0x840>
ffffffffc02038fa:	45a5                	li	a1,9
ffffffffc02038fc:	00002517          	auipc	a0,0x2
ffffffffc0203900:	eb450513          	addi	a0,a0,-332 # ffffffffc02057b0 <default_pmm_manager+0xac0>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0203904:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0203906:	b55fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020390a <schedule>:
}

void
schedule(void) {
ffffffffc020390a:	1141                	addi	sp,sp,-16
ffffffffc020390c:	e406                	sd	ra,8(sp)
ffffffffc020390e:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203910:	100027f3          	csrr	a5,sstatus
ffffffffc0203914:	8b89                	andi	a5,a5,2
ffffffffc0203916:	4401                	li	s0,0
ffffffffc0203918:	efbd                	bnez	a5,ffffffffc0203996 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc020391a:	0000a897          	auipc	a7,0xa
ffffffffc020391e:	bb68b883          	ld	a7,-1098(a7) # ffffffffc020d4d0 <current>
ffffffffc0203922:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0203926:	0000a517          	auipc	a0,0xa
ffffffffc020392a:	bb253503          	ld	a0,-1102(a0) # ffffffffc020d4d8 <idleproc>
ffffffffc020392e:	04a88e63          	beq	a7,a0,ffffffffc020398a <schedule+0x80>
ffffffffc0203932:	0c888693          	addi	a3,a7,200
ffffffffc0203936:	0000a617          	auipc	a2,0xa
ffffffffc020393a:	b2260613          	addi	a2,a2,-1246 # ffffffffc020d458 <proc_list>
        le = last;
ffffffffc020393e:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0203942:	4809                	li	a6,2
ffffffffc0203944:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0203946:	00c78863          	beq	a5,a2,ffffffffc0203956 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020394a:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc020394e:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0203952:	03070163          	beq	a4,a6,ffffffffc0203974 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0203956:	fef697e3          	bne	a3,a5,ffffffffc0203944 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020395a:	ed89                	bnez	a1,ffffffffc0203974 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc020395c:	451c                	lw	a5,8(a0)
ffffffffc020395e:	2785                	addiw	a5,a5,1
ffffffffc0203960:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0203962:	00a88463          	beq	a7,a0,ffffffffc020396a <schedule+0x60>
            proc_run(next);
ffffffffc0203966:	991ff0ef          	jal	ra,ffffffffc02032f6 <proc_run>
    if (flag) {
ffffffffc020396a:	e819                	bnez	s0,ffffffffc0203980 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc020396c:	60a2                	ld	ra,8(sp)
ffffffffc020396e:	6402                	ld	s0,0(sp)
ffffffffc0203970:	0141                	addi	sp,sp,16
ffffffffc0203972:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0203974:	4198                	lw	a4,0(a1)
ffffffffc0203976:	4789                	li	a5,2
ffffffffc0203978:	fef712e3          	bne	a4,a5,ffffffffc020395c <schedule+0x52>
ffffffffc020397c:	852e                	mv	a0,a1
ffffffffc020397e:	bff9                	j	ffffffffc020395c <schedule+0x52>
}
ffffffffc0203980:	6402                	ld	s0,0(sp)
ffffffffc0203982:	60a2                	ld	ra,8(sp)
ffffffffc0203984:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0203986:	fa5fc06f          	j	ffffffffc020092a <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020398a:	0000a617          	auipc	a2,0xa
ffffffffc020398e:	ace60613          	addi	a2,a2,-1330 # ffffffffc020d458 <proc_list>
ffffffffc0203992:	86b2                	mv	a3,a2
ffffffffc0203994:	b76d                	j	ffffffffc020393e <schedule+0x34>
        intr_disable();
ffffffffc0203996:	f9bfc0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc020399a:	4405                	li	s0,1
ffffffffc020399c:	bfbd                	j	ffffffffc020391a <schedule+0x10>

ffffffffc020399e <hash32>:
 *
...
ffffffffc020399e:	9e3707b7          	lui	a5,0x9e370
ffffffffc02039a2:	2785                	addiw	a5,a5,1
ffffffffc02039a4:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02039a8:	02000793          	li	a5,32
ffffffffc02039ac:	9f8d                	subw	a5,a5,a1
}
ffffffffc02039ae:	00f5553b          	srlw	a0,a0,a5
ffffffffc02039b2:	8082                	ret

ffffffffc02039b4 <printnum>:
 * */
static void
...
ffffffffc02039b4:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039b8:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02039ba:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039be:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02039c0:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039c4:	f022                	sd	s0,32(sp)
ffffffffc02039c6:	ec26                	sd	s1,24(sp)
ffffffffc02039c8:	e84a                	sd	s2,16(sp)
ffffffffc02039ca:	f406                	sd	ra,40(sp)
ffffffffc02039cc:	e44e                	sd	s3,8(sp)
ffffffffc02039ce:	84aa                	mv	s1,a0
ffffffffc02039d0:	892e                	mv	s2,a1
...
ffffffffc02039d2:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02039d6:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc02039d8:	03067e63          	bgeu	a2,a6,ffffffffc0203a14 <printnum+0x60>
ffffffffc02039dc:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc02039de:	00805763          	blez	s0,ffffffffc02039ec <printnum+0x38>
ffffffffc02039e2:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02039e4:	85ca                	mv	a1,s2
ffffffffc02039e6:	854e                	mv	a0,s3
ffffffffc02039e8:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc02039ea:	fc65                	bnez	s0,ffffffffc02039e2 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02039ec:	1a02                	slli	s4,s4,0x20
ffffffffc02039ee:	00002797          	auipc	a5,0x2
ffffffffc02039f2:	dda78793          	addi	a5,a5,-550 # ffffffffc02057c8 <default_pmm_manager+0xad8>
ffffffffc02039f6:	020a5a13          	srli	s4,s4,0x20
ffffffffc02039fa:	9a3e                	add	s4,s4,a5
}
ffffffffc02039fc:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02039fe:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203a02:	70a2                	ld	ra,40(sp)
ffffffffc0203a04:	69a2                	ld	s3,8(sp)
...
ffffffffc0203a1a:	f9bff0ef          	jal	ra,ffffffffc02039b4 <printnum>
ffffffffc0203a1e:	b7f9                	j	ffffffffc02039ec <printnum+0x38>
...
ffffffffc0203a44:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203a48:	5b7d                	li	s6,-1
ffffffffc0203a4a:	00002a97          	auipc	s5,0x2
ffffffffc0203a4e:	daaa8a93          	addi	s5,s5,-598 # ffffffffc02057f4 <default_pmm_manager+0xb04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203a52:	00002b97          	auipc	s7,0x2
ffffffffc0203a56:	f7eb8b93          	addi	s7,s7,-130 # ffffffffc02059d0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a5a:	000d4503          	lbu	a0,0(s10)
ffffffffc0203a5e:	001d0413          	addi	s0,s10,1
ffffffffc0203a62:	01350a63          	beq	a0,s3,ffffffffc0203a76 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203a66:	c121                	beqz	a0,ffffffffc0203aa6 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203a68:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a6a:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203a6c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a6e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203a72:	ff351ae3          	bne	a0,s3,ffffffffc0203a66 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a76:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203a7a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203a7e:	4c81                	li	s9,0
ffffffffc0203a80:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203a82:	5c7d                	li	s8,-1
ffffffffc0203a84:	5dfd                	li	s11,-1
ffffffffc0203a86:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203a8a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a8c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203a90:	0ff5f593          	zext.b	a1,a1
ffffffffc0203a94:	00140d13          	addi	s10,s0,1
ffffffffc0203a98:	04b56263          	bltu	a0,a1,ffffffffc0203adc <vprintfmt+0xbc>
ffffffffc0203a9c:	058a                	slli	a1,a1,0x2
ffffffffc0203a9e:	95d6                	add	a1,a1,s5
ffffffffc0203aa0:	4194                	lw	a3,0(a1)
ffffffffc0203aa2:	96d6                	add	a3,a3,s5
ffffffffc0203aa4:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203aa6:	70e6                	ld	ra,120(sp)
ffffffffc0203aa8:	7446                	ld	s0,112(sp)
ffffffffc0203aaa:	74a6                	ld	s1,104(sp)
ffffffffc0203aac:	7906                	ld	s2,96(sp)
ffffffffc0203aae:	69e6                	ld	s3,88(sp)
ffffffffc0203ab0:	6a46                	ld	s4,80(sp)
ffffffffc0203ab2:	6aa6                	ld	s5,72(sp)
ffffffffc0203ab4:	6b06                	ld	s6,64(sp)
ffffffffc0203ab6:	7be2                	ld	s7,56(sp)
ffffffffc0203ab8:	7c42                	ld	s8,48(sp)
ffffffffc0203aba:	7ca2                	ld	s9,40(sp)
ffffffffc0203abc:	7d02                	ld	s10,32(sp)
ffffffffc0203abe:	6de2                	ld	s11,24(sp)
ffffffffc0203ac0:	6109                	addi	sp,sp,128
ffffffffc0203ac2:	8082                	ret
            padc = '0';
ffffffffc0203ac4:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203ac6:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203aca:	846a                	mv	s0,s10
ffffffffc0203acc:	00140d13          	addi	s10,s0,1
ffffffffc0203ad0:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203ad4:	0ff5f593          	zext.b	a1,a1
ffffffffc0203ad8:	fcb572e3          	bgeu	a0,a1,ffffffffc0203a9c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203adc:	85a6                	mv	a1,s1
ffffffffc0203ade:	02500513          	li	a0,37
ffffffffc0203ae2:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203ae4:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203ae8:	8d22                	mv	s10,s0
ffffffffc0203aea:	f73788e3          	beq	a5,s3,ffffffffc0203a5a <vprintfmt+0x3a>
ffffffffc0203aee:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203af2:	1d7d                	addi	s10,s10,-1
ffffffffc0203af4:	ff379de3          	bne	a5,s3,ffffffffc0203aee <vprintfmt+0xce>
ffffffffc0203af8:	b78d                	j	ffffffffc0203a5a <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203afa:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203afe:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b02:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203b04:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203b08:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b0c:	02d86463          	bltu	a6,a3,ffffffffc0203b34 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203b10:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203b14:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203b18:	0186873b          	addw	a4,a3,s8
ffffffffc0203b1c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203b20:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203b22:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203b26:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203b28:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203b2c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b30:	fed870e3          	bgeu	a6,a3,ffffffffc0203b10 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203b34:	f40ddce3          	bgez	s11,ffffffffc0203a8c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203b38:	8de2                	mv	s11,s8
ffffffffc0203b3a:	5c7d                	li	s8,-1
ffffffffc0203b3c:	bf81                	j	ffffffffc0203a8c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203b3e:	fffdc693          	not	a3,s11
ffffffffc0203b42:	96fd                	srai	a3,a3,0x3f
ffffffffc0203b44:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b48:	00144603          	lbu	a2,1(s0)
ffffffffc0203b4c:	2d81                	sext.w	s11,s11
ffffffffc0203b4e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b50:	bf35                	j	ffffffffc0203a8c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203b52:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b56:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203b5a:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b5c:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203b5e:	bfd9                	j	ffffffffc0203b34 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203b60:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b62:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b66:	01174463          	blt	a4,a7,ffffffffc0203b6e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203b6a:	1a088e63          	beqz	a7,ffffffffc0203d26 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203b6e:	000a3603          	ld	a2,0(s4)
ffffffffc0203b72:	46c1                	li	a3,16
ffffffffc0203b74:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203b76:	2781                	sext.w	a5,a5
ffffffffc0203b78:	876e                	mv	a4,s11
ffffffffc0203b7a:	85a6                	mv	a1,s1
ffffffffc0203b7c:	854a                	mv	a0,s2
ffffffffc0203b7e:	e37ff0ef          	jal	ra,ffffffffc02039b4 <printnum>
            break;
ffffffffc0203b82:	bde1                	j	ffffffffc0203a5a <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203b84:	000a2503          	lw	a0,0(s4)
ffffffffc0203b88:	85a6                	mv	a1,s1
ffffffffc0203b8a:	0a21                	addi	s4,s4,8
ffffffffc0203b8c:	9902                	jalr	s2
            break;
ffffffffc0203b8e:	b5f1                	j	ffffffffc0203a5a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203b90:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b92:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b96:	01174463          	blt	a4,a7,ffffffffc0203b9e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203b9a:	18088163          	beqz	a7,ffffffffc0203d1c <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203b9e:	000a3603          	ld	a2,0(s4)
ffffffffc0203ba2:	46a9                	li	a3,10
ffffffffc0203ba4:	8a2e                	mv	s4,a1
ffffffffc0203ba6:	bfc1                	j	ffffffffc0203b76 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ba8:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203bac:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bae:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bb0:	bdf1                	j	ffffffffc0203a8c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203bb2:	85a6                	mv	a1,s1
ffffffffc0203bb4:	02500513          	li	a0,37
ffffffffc0203bb8:	9902                	jalr	s2
            break;
ffffffffc0203bba:	b545                	j	ffffffffc0203a5a <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bbc:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203bc0:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bc2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bc4:	b5e1                	j	ffffffffc0203a8c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203bc6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bc8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bcc:	01174463          	blt	a4,a7,ffffffffc0203bd4 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203bd0:	14088163          	beqz	a7,ffffffffc0203d12 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203bd4:	000a3603          	ld	a2,0(s4)
ffffffffc0203bd8:	46a1                	li	a3,8
ffffffffc0203bda:	8a2e                	mv	s4,a1
ffffffffc0203bdc:	bf69                	j	ffffffffc0203b76 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203bde:	03000513          	li	a0,48
ffffffffc0203be2:	85a6                	mv	a1,s1
ffffffffc0203be4:	e03e                	sd	a5,0(sp)
ffffffffc0203be6:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203be8:	85a6                	mv	a1,s1
ffffffffc0203bea:	07800513          	li	a0,120
ffffffffc0203bee:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bf0:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203bf2:	6782                	ld	a5,0(sp)
ffffffffc0203bf4:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bf6:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203bfa:	bfb5                	j	ffffffffc0203b76 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203bfc:	000a3403          	ld	s0,0(s4)
ffffffffc0203c00:	008a0713          	addi	a4,s4,8
ffffffffc0203c04:	e03a                	sd	a4,0(sp)
ffffffffc0203c06:	14040263          	beqz	s0,ffffffffc0203d4a <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203c0a:	0fb05763          	blez	s11,ffffffffc0203cf8 <vprintfmt+0x2d8>
ffffffffc0203c0e:	02d00693          	li	a3,45
ffffffffc0203c12:	0cd79163          	bne	a5,a3,ffffffffc0203cd4 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c16:	00044783          	lbu	a5,0(s0)
ffffffffc0203c1a:	0007851b          	sext.w	a0,a5
ffffffffc0203c1e:	cf85                	beqz	a5,ffffffffc0203c56 <vprintfmt+0x236>
ffffffffc0203c20:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c24:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c28:	000c4563          	bltz	s8,ffffffffc0203c32 <vprintfmt+0x212>
ffffffffc0203c2c:	3c7d                	addiw	s8,s8,-1
ffffffffc0203c2e:	036c0263          	beq	s8,s6,ffffffffc0203c52 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203c32:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c34:	0e0c8e63          	beqz	s9,ffffffffc0203d30 <vprintfmt+0x310>
ffffffffc0203c38:	3781                	addiw	a5,a5,-32
ffffffffc0203c3a:	0ef47b63          	bgeu	s0,a5,ffffffffc0203d30 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203c3e:	03f00513          	li	a0,63
ffffffffc0203c42:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c44:	000a4783          	lbu	a5,0(s4)
ffffffffc0203c48:	3dfd                	addiw	s11,s11,-1
ffffffffc0203c4a:	0a05                	addi	s4,s4,1
ffffffffc0203c4c:	0007851b          	sext.w	a0,a5
ffffffffc0203c50:	ffe1                	bnez	a5,ffffffffc0203c28 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203c52:	01b05963          	blez	s11,ffffffffc0203c64 <vprintfmt+0x244>
ffffffffc0203c56:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203c58:	85a6                	mv	a1,s1
ffffffffc0203c5a:	02000513          	li	a0,32
ffffffffc0203c5e:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203c60:	fe0d9be3          	bnez	s11,ffffffffc0203c56 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c64:	6a02                	ld	s4,0(sp)
ffffffffc0203c66:	bbd5                	j	ffffffffc0203a5a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203c68:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203c6a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203c6e:	01174463          	blt	a4,a7,ffffffffc0203c76 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203c72:	08088d63          	beqz	a7,ffffffffc0203d0c <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203c76:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203c7a:	0a044d63          	bltz	s0,ffffffffc0203d34 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203c7e:	8622                	mv	a2,s0
ffffffffc0203c80:	8a66                	mv	s4,s9
ffffffffc0203c82:	46a9                	li	a3,10
ffffffffc0203c84:	bdcd                	j	ffffffffc0203b76 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203c86:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c8a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203c8c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203c8e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203c92:	8fb5                	xor	a5,a5,a3
ffffffffc0203c94:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c98:	02d74163          	blt	a4,a3,ffffffffc0203cba <vprintfmt+0x29a>
ffffffffc0203c9c:	00369793          	slli	a5,a3,0x3
ffffffffc0203ca0:	97de                	add	a5,a5,s7
ffffffffc0203ca2:	639c                	ld	a5,0(a5)
ffffffffc0203ca4:	cb99                	beqz	a5,ffffffffc0203cba <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203ca6:	86be                	mv	a3,a5
ffffffffc0203ca8:	00000617          	auipc	a2,0x0
ffffffffc0203cac:	21860613          	addi	a2,a2,536 # ffffffffc0203ec0 <etext+0x2e>
ffffffffc0203cb0:	85a6                	mv	a1,s1
ffffffffc0203cb2:	854a                	mv	a0,s2
ffffffffc0203cb4:	0ce000ef          	jal	ra,ffffffffc0203d82 <printfmt>
ffffffffc0203cb8:	b34d                	j	ffffffffc0203a5a <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203cba:	00002617          	auipc	a2,0x2
ffffffffc0203cbe:	b2e60613          	addi	a2,a2,-1234 # ffffffffc02057e8 <default_pmm_manager+0xaf8>
ffffffffc0203cc2:	85a6                	mv	a1,s1
ffffffffc0203cc4:	854a                	mv	a0,s2
ffffffffc0203cc6:	0bc000ef          	jal	ra,ffffffffc0203d82 <printfmt>
ffffffffc0203cca:	bb41                	j	ffffffffc0203a5a <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203ccc:	00002417          	auipc	s0,0x2
ffffffffc0203cd0:	b1440413          	addi	s0,s0,-1260 # ffffffffc02057e0 <default_pmm_manager+0xaf0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cd4:	85e2                	mv	a1,s8
ffffffffc0203cd6:	8522                	mv	a0,s0
ffffffffc0203cd8:	e43e                	sd	a5,8(sp)
ffffffffc0203cda:	0e2000ef          	jal	ra,ffffffffc0203dbc <strnlen>
ffffffffc0203cde:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203ce2:	01b05b63          	blez	s11,ffffffffc0203cf8 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203ce6:	67a2                	ld	a5,8(sp)
ffffffffc0203ce8:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cec:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203cee:	85a6                	mv	a1,s1
ffffffffc0203cf0:	8552                	mv	a0,s4
ffffffffc0203cf2:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cf4:	fe0d9ce3          	bnez	s11,ffffffffc0203cec <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203cf8:	00044783          	lbu	a5,0(s0)
ffffffffc0203cfc:	00140a13          	addi	s4,s0,1
ffffffffc0203d00:	0007851b          	sext.w	a0,a5
ffffffffc0203d04:	d3a5                	beqz	a5,ffffffffc0203c64 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d06:	05e00413          	li	s0,94
ffffffffc0203d0a:	bf39                	j	ffffffffc0203c28 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203d0c:	000a2403          	lw	s0,0(s4)
ffffffffc0203d10:	b7ad                	j	ffffffffc0203c7a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203d12:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d16:	46a1                	li	a3,8
ffffffffc0203d18:	8a2e                	mv	s4,a1
ffffffffc0203d1a:	bdb1                	j	ffffffffc0203b76 <vprintfmt+0x156>
ffffffffc0203d1c:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d20:	46a9                	li	a3,10
ffffffffc0203d22:	8a2e                	mv	s4,a1
ffffffffc0203d24:	bd89                	j	ffffffffc0203b76 <vprintfmt+0x156>
ffffffffc0203d26:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d2a:	46c1                	li	a3,16
ffffffffc0203d2c:	8a2e                	mv	s4,a1
ffffffffc0203d2e:	b5a1                	j	ffffffffc0203b76 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203d30:	9902                	jalr	s2
ffffffffc0203d32:	bf09                	j	ffffffffc0203c44 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203d34:	85a6                	mv	a1,s1
ffffffffc0203d36:	02d00513          	li	a0,45
ffffffffc0203d3a:	e03e                	sd	a5,0(sp)
ffffffffc0203d3c:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203d3e:	6782                	ld	a5,0(sp)
ffffffffc0203d40:	8a66                	mv	s4,s9
ffffffffc0203d42:	40800633          	neg	a2,s0
ffffffffc0203d46:	46a9                	li	a3,10
ffffffffc0203d48:	b53d                	j	ffffffffc0203b76 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203d4a:	03b05163          	blez	s11,ffffffffc0203d6c <vprintfmt+0x34c>
ffffffffc0203d4e:	02d00693          	li	a3,45
ffffffffc0203d52:	f6d79de3          	bne	a5,a3,ffffffffc0203ccc <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203d56:	00002417          	auipc	s0,0x2
ffffffffc0203d5a:	a8a40413          	addi	s0,s0,-1398 # ffffffffc02057e0 <default_pmm_manager+0xaf0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d5e:	02800793          	li	a5,40
ffffffffc0203d62:	02800513          	li	a0,40
ffffffffc0203d66:	00140a13          	addi	s4,s0,1
ffffffffc0203d6a:	bd6d                	j	ffffffffc0203c24 <vprintfmt+0x204>
ffffffffc0203d6c:	00002a17          	auipc	s4,0x2
ffffffffc0203d70:	a75a0a13          	addi	s4,s4,-1419 # ffffffffc02057e1 <default_pmm_manager+0xaf1>
ffffffffc0203d74:	02800513          	li	a0,40
ffffffffc0203d78:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d7c:	05e00413          	li	s0,94
ffffffffc0203d80:	b565                	j	ffffffffc0203c28 <vprintfmt+0x208>

ffffffffc0203d82 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d82:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203d84:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d88:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d8a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d8c:	ec06                	sd	ra,24(sp)
ffffffffc0203d8e:	f83a                	sd	a4,48(sp)
ffffffffc0203d90:	fc3e                	sd	a5,56(sp)
ffffffffc0203d92:	e0c2                	sd	a6,64(sp)
ffffffffc0203d94:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203d96:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d98:	c89ff0ef          	jal	ra,ffffffffc0203a20 <vprintfmt>
}
ffffffffc0203d9c:	60e2                	ld	ra,24(sp)
ffffffffc0203d9e:	6161                	addi	sp,sp,80
ffffffffc0203da0:	8082                	ret

ffffffffc0203da2 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0203da2:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0203da6:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203da8:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203daa:	cb81                	beqz	a5,ffffffffc0203dba <strlen+0x18>
        cnt ++;
ffffffffc0203dac:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203dae:	00a707b3          	add	a5,a4,a0
ffffffffc0203db2:	0007c783          	lbu	a5,0(a5)
ffffffffc0203db6:	fbfd                	bnez	a5,ffffffffc0203dac <strlen+0xa>
...
ffffffffc0203dbc:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203dbe:	e589                	bnez	a1,ffffffffc0203dc8 <strnlen+0xc>
ffffffffc0203dc0:	a811                	j	ffffffffc0203dd4 <strnlen+0x18>
        cnt ++;
ffffffffc0203dc2:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203dc4:	00f58863          	beq	a1,a5,ffffffffc0203dd4 <strnlen+0x18>
ffffffffc0203dc8:	00f50733          	add	a4,a0,a5
ffffffffc0203dcc:	00074703          	lbu	a4,0(a4)
ffffffffc0203dd0:	fb6d                	bnez	a4,ffffffffc0203dc2 <strnlen+0x6>
ffffffffc0203dd2:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203dd4:	852e                	mv	a0,a1
ffffffffc0203dd6:	8082                	ret

ffffffffc0203dd8 <strcpy>:
char *
...
ffffffffc0203dd8:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0203dda:	0005c703          	lbu	a4,0(a1)
ffffffffc0203dde:	0785                	addi	a5,a5,1
ffffffffc0203de0:	0585                	addi	a1,a1,1
ffffffffc0203de2:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203de6:	fb75                	bnez	a4,ffffffffc0203dda <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203dea:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203dee:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203df2:	cb89                	beqz	a5,ffffffffc0203e04 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203df4:	0505                	addi	a0,a0,1
ffffffffc0203df6:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203df8:	fee789e3          	beq	a5,a4,ffffffffc0203dea <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203dfc:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0203e00:	9d19                	subw	a0,a0,a4
ffffffffc0203e02:	8082                	ret
ffffffffc0203e04:	4501                	li	a0,0
ffffffffc0203e06:	bfed                	j	ffffffffc0203e00 <strcmp+0x16>

ffffffffc0203e08 <strncmp>:
...
ffffffffc0203e08:	c20d                	beqz	a2,ffffffffc0203e2a <strncmp+0x22>
ffffffffc0203e0a:	962e                	add	a2,a2,a1
ffffffffc0203e0c:	a031                	j	ffffffffc0203e18 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203e0e:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e10:	00e79a63          	bne	a5,a4,ffffffffc0203e24 <strncmp+0x1c>
ffffffffc0203e14:	00b60b63          	beq	a2,a1,ffffffffc0203e2a <strncmp+0x22>
ffffffffc0203e18:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203e1c:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e1e:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203e22:	f7f5                	bnez	a5,ffffffffc0203e0e <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e24:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc0203e32:	c799                	beqz	a5,ffffffffc0203e40 <strchr+0x12>
        if (*s == c) {
ffffffffc0203e34:	00f58763          	beq	a1,a5,ffffffffc0203e42 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203e38:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203e3c:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203e3e:	fbfd                	bnez	a5,ffffffffc0203e34 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0203e44:	ca01                	beqz	a2,ffffffffc0203e54 <memset+0x10>
ffffffffc0203e46:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0203e48:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0203e4a:	0785                	addi	a5,a5,1
ffffffffc0203e4c:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0203e50:	fec79de3          	bne	a5,a2,ffffffffc0203e4a <memset+0x6>
    }
    return s;
...
ffffffffc0203e56 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0203e56:	ca19                	beqz	a2,ffffffffc0203e6c <memcpy+0x16>
ffffffffc0203e58:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0203e5a:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0203e5c:	0005c703          	lbu	a4,0(a1)
ffffffffc0203e60:	0585                	addi	a1,a1,1
ffffffffc0203e62:	0785                	addi	a5,a5,1
ffffffffc0203e64:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0203e68:	fec59ae3          	bne	a1,a2,ffffffffc0203e5c <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203e6e:	c205                	beqz	a2,ffffffffc0203e8e <memcmp+0x20>
ffffffffc0203e70:	962e                	add	a2,a2,a1
ffffffffc0203e72:	a019                	j	ffffffffc0203e78 <memcmp+0xa>
ffffffffc0203e74:	00c58d63          	beq	a1,a2,ffffffffc0203e8e <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0203e78:	00054783          	lbu	a5,0(a0)
ffffffffc0203e7c:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0203e80:	0505                	addi	a0,a0,1
ffffffffc0203e82:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203e84:	fee788e3          	beq	a5,a4,ffffffffc0203e74 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e88:	40e7853b          	subw	a0,a5,a4
